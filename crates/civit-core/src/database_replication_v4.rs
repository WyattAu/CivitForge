...
pub struct ReplicationConfigEntryV2 {
    pub id: Uuid,
    pub replica_id: Uuid,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ReplicationAlertEntryV2 {
    pub id: Uuid,
    pub replica_id: Uuid,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ReplicationMonitoringResultV2 {
    pub replica_id: Uuid,
    pub replica_name: String,
    pub lag_ms: i32,
    pub status: String,
    pub healthy: bool,
    pub alerts: Vec<ReplicationAlertEntryV2>,
    pub config: Vec<ReplicationConfigEntryV2>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FailoverTestResultV2 {
    pub replica_id: Uuid,
    pub success: bool,
    pub duration_ms: i32,
...
pub struct DatabaseReplicationV4Service {
    pool: PgPool,
}

impl DatabaseReplicationV4Service {
    ...
    pub async fn set_config(
    ...
    ) -> Result<ReplicationConfigEntryV2, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct ConfigRow {
            id: Uuid,
            replica_id: Uuid,
        ...
        let row = sqlx::query_as::<_, ConfigRow>(
            r#"INSERT INTO database_replication_config_v2 (replica_id, config_key, config_value)
             VALUES ($1, $2, $3)
    ...
    pub async fn get_config(
        ...
        replica_id: Uuid,
        config_key: &str,
    ) -> Result<Option<ReplicationConfigEntryV2>, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct ConfigRow {
            id: Uuid,
            replica_id: Uuid,
        ...
        let row = sqlx::query_as::<_, ConfigRow>(
            r#"SELECT id, replica_id, config_key, config_value, created_at
             FROM database_replication_config_v2
        ...
        Ok(row.map(|r| ReplicationConfigEntryV2 {
            id: r.id,
    ...
    pub async fn get_all_config(
        &self,
        replica_id: Uuid,
    ) -> Result<Vec<ReplicationConfigEntryV2>, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct ConfigRow {
            id: Uuid,
            replica_id: Uuid,
        ...
        Ok(rows
            .into_iter()
            .map(|r| ReplicationConfigEntryV2 {
                id: r.id,
                replica_id: r.replica_id,
                config_key: r.config_key,
                config_value: r.config_value,
    ...
    pub async fn create_alert(
        ...
        alert_type: &str,
        threshold: f64,
    ) -> Result<ReplicationAlertEntryV2, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct AlertRow {
            id: Uuid,
            replica_id: Uuid,
        ...
        let row = sqlx::query_as::<_, AlertRow>(
            r#"INSERT INTO database_replication_alerts_v2 (replica_id, alert_type, threshold)
             VALUES ($1, $2, $3)
    ...
    pub async fn get_alerts(
        &self,
        replica_id: Uuid,
    ) -> Result<Vec<ReplicationAlertEntryV2>, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct AlertRow {
            id: Uuid,
            replica_id: Uuid,
        ...
        let rows = sqlx::query_as::<_, AlertRow>(
            r#"SELECT id, replica_id, alert_type, threshold, enabled, last_triggered_at, created_at
             FROM database_replication_alerts_v2
             WHERE replica_id = $1
    ...
    pub async fn monitor_replication(&self) -> Result<Vec<ReplicationMonitoringResultV2>, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct ReplicaRow {
            id: Uuid,
            name: String,
        ...
        for replica in replicas {
            ...
            results.push(ReplicationMonitoringResultV2 {
    ...
    pub async fn test_failover(
        &self,
        replica_id: Uuid,
    ) -> Result<FailoverTestResultV2, sqlx::Error> {
        let start = Utc::now();
        ...
        if replica_exists.is_none() {
            return Ok(FailoverTestResultV2 {
                replica_id,
                success: false,
                duration_ms: 0,
        ...
        let config_count: (i64,) = sqlx::query_as(
            r#"SELECT COUNT(*) FROM database_replication_config_v2 WHERE replica_id = $1"#,
        )
        .bind(replica_id)
        .fetch_one(&self.pool)
        .await?;
        ...
        let alert_count: (i64,) = sqlx::query_as(
            r#"SELECT COUNT(*) FROM database_replication_alerts_v2 WHERE replica_id = $1"#,
        )
        .bind(replica_id)
        .fetch_one(&self.pool)
        .await?;
