...
pub struct ComplianceFrameworkV5 {
    pub id: String,
    pub name: String,
    pub version: String,
    pub description: String,
    pub requirements: Vec<ComplianceRequirementV5>,
    pub enabled: bool,
    pub created_at: DateTime<Utc>,
    pub updated_at: DateTime<Utc>,
}

impl ComplianceFrameworkV5 {
    ...
    pub fn add_requirement(&mut self, requirement: ComplianceRequirementV5) {
        self.requirements.push(requirement);
    }

    pub fn mandatory_requirements(&self) -> Vec<&ComplianceRequirementV5> {
        self.requirements.iter().filter(|r| r.mandatory).collect()
    }

    pub fn requirements_by_category(&self, category: &str) -> Vec<&ComplianceRequirementV5> {
        self.requirements
            .iter()
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ComplianceRequirementV5 {
    pub id: String,
    pub name: String,
    pub description: String,
    pub category: String,
    pub mandatory: bool,
    pub weight: u32,
    pub verification_method: VerificationMethodV5,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum VerificationMethodV5 {
    Automated,
    Manual,
    Hybrid,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ComplianceAssessmentV5 {
    pub id: String,
    pub framework_id: String,
    pub repo_id: Option<String>,
    pub status: AssessmentStatusV5,
    pub findings: Vec<ComplianceFindingV5>,
    pub score: u32,
    pub assessor_id: Option<String>,
    pub started_at: DateTime<Utc>,
    pub completed_at: Option<DateTime<Utc>>,
    pub history: Vec<AssessmentSnapshotV5>,
}

impl ComplianceAssessmentV5 {
    pub fn new(framework_id: String) -> Self {
        Self {
            id: uuid::Uuid::new_v4().to_string(),
            framework_id,
            repo_id: None,
            status: AssessmentStatusV5::Pending,
            findings: Vec::new(),
            score: 0,
            assessor_id: None,
            started_at: Utc::now(),
    ...
    pub fn add_finding(&mut self, finding: ComplianceFindingV5) {
    ...
    pub fn complete(&mut self, score: u32) {
        self.status = if self
            .findings
            .iter()
            .any(|f| f.status == FindingStatusV5::NonCompliant)
        {
            AssessmentStatusV5::Failed
        } else if self
            .findings
            .iter()
            .any(|f| f.status == FindingStatusV5::Partial)
        {
            AssessmentStatusV5::Partial
        } else {
            AssessmentStatusV5::Passed
        };
        self.score = score;
    ...
    fn snapshot_history(&mut self) {
        self.history.push(AssessmentSnapshotV5 {
            status: self.status,
            score: self.score,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct AssessmentSnapshotV5 {
    pub status: AssessmentStatusV5,
    pub score: u32,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ComplianceFindingV5 {
    pub id: String,
    pub requirement_id: String,
    pub status: FindingStatusV5,
    pub details: String,
...
impl ComplianceFindingV5 {
    pub fn is_compliant(&self) -> bool {
        self.status == FindingStatusV5::Compliant || self.status == FindingStatusV5::NotApplicable
    }
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FindingTrackerV5 {
    pub findings: Vec<ComplianceFindingV5>,
    pub remediation_deadlines: HashMap<String, DateTime<Utc>>,
    pub assigned_to: HashMap<String, String>,
    pub finding_history: Vec<FindingHistoryEntry>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FindingHistoryEntry {
    pub finding_id: String,
    pub previous_status: FindingStatusV5,
    pub new_status: FindingStatusV5,
    pub changed_by: Option<String>,
    pub changed_at: DateTime<Utc>,
}

impl FindingTrackerV5 {
    pub fn new() -> Self {
        Self {
            findings: Vec::new(),
    ...
    pub fn update_finding_status(
        ...
        self.finding_history.push(FindingHistoryEntry {
    ...
    pub fn overdue_findings(&self) -> Vec<&ComplianceFindingV5> {
        let now = Utc::now();
        self.findings
            .iter()
            .filter(|f| {
    ...
    pub fn open_findings(&self) -> Vec<&ComplianceFindingV5> {
        self.findings
            .iter()
            .filter(|f| {
                f.status == FindingStatusV5::NonCompliant || f.status == FindingStatusV5::Partial
            })
            .collect()
    }

    pub fn get_finding_history(&self, finding_id: &str) -> Vec<&FindingHistoryEntry> {
...
impl Default for FindingTrackerV5 {
    fn default() -> Self {
        Self::new()
    }
}
...
impl ComplianceScoringEngineV5 {
    pub fn calculate_framework_score(
        requirements: &[ComplianceRequirementV5],
        findings: &[ComplianceFindingV5],
    ) -> ComplianceScoreV5 {
        let total = requirements.len() as u32;
        if total == 0 {
            return ComplianceScoreV5 {
                overall: 100,
        ...
        for finding in findings {
            ...
            match finding.status {
                FindingStatusV5::Compliant => {
                    passed += 1;
                    earned_weight += req_weight;
                }
                FindingStatusV5::NonCompliant => {
                    failed += 1;
                }
                FindingStatusV5::Partial => {
                    partial += 1;
                    earned_weight += req_weight / 2;
                }
                FindingStatusV5::NotApplicable => {
                    not_applicable += 1;
                }
            }
            ...
            let entry = by_category
                ...
                .or_insert((0, 0));
            match finding.status {
                FindingStatusV5::Compliant => entry.0 += 1,
                FindingStatusV5::NonCompliant => entry.1 += 1,
                FindingStatusV5::Partial => {
                    entry.0 += 1;
                    entry.1 += 1;
                }
...
impl ComplianceAssessorV5 {
    pub fn assess(
        framework: &ComplianceFrameworkV5,
        findings: &[ComplianceFindingV5],
    ) -> AssessmentResultV5 {
        ...
        if total_requirements == 0 {
            return AssessmentResultV5 {
                score: 100,
                status: AssessmentStatusV5::Passed,
                compliant_count: 0,
        ...
        for finding in findings {
            match finding.status {
                FindingStatusV5::Compliant => compliant += 1,
                FindingStatusV5::NonCompliant => non_compliant += 1,
                FindingStatusV5::Partial => partial += 1,
                FindingStatusV5::NotApplicable => not_applicable += 1,
            }
        }
...
pub fn create_soc2_framework_v5() -> ComplianceFrameworkV5 {
    let mut framework = ComplianceFrameworkV5::new(
        "SOC 2".into(),
        "Service Organization Control 2".into(),
    );
    framework.add_requirement(ComplianceRequirementV5 {
        id: "CC6.1".into(),
        ...
        mandatory: true,
        weight: 4,
        verification_method: VerificationMethodV5::Automated,
    });
    framework.add_requirement(ComplianceRequirementV5 {
        id: "CC6.6".into(),
        ...
        mandatory: true,
        weight: 3,
        verification_method: VerificationMethodV5::Hybrid,
    });
    framework.add_requirement(ComplianceRequirementV5 {
        id: "CC7.1".into(),
    ...
    framework.add_requirement(ComplianceRequirementV5 {
        ...
        mandatory: true,
        weight: 3,
        verification_method: VerificationMethodV5::Manual,
    });
    framework
}

pub fn create_iso27001_framework_v5() -> ComplianceFrameworkV5 {
    let mut framework = ComplianceFrameworkV5::new(
        "ISO 27001".into(),
...
mod tests {
    ...
    fn make_finding(requirement_id: &str, status: FindingStatusV5) -> ComplianceFindingV5 {
        ComplianceFindingV5 {
            id: uuid::Uuid::new_v4().to_string(),
    ...
    fn test_framework_new() {
        let fw = ComplianceFrameworkV5::new("Test".into(), "Description".into());
        assert_eq!(fw.name, "Test");
        assert_eq!(fw.version, "3.0");
        assert!(fw.enabled);
    ...
    fn test_framework_with_version() {
        let fw = ComplianceFrameworkV5::new("Test".into(), "Desc".into()).with_version("2.1");
        assert_eq!(fw.version, "2.1");
    }

    #[test]
    fn test_framework_increment_version() {
        let mut fw = ComplianceFrameworkV5::new("Test".into(), "Desc".into());
        fw.increment_version();
        assert_eq!(fw.version, "3.1");
        fw.increment_version();
        assert_eq!(fw.version, "3.2");
    }

    #[test]
    fn test_add_requirement() {
        let mut fw = ComplianceFrameworkV5::new("Test".into(), "Desc".into());
        fw.add_requirement(ComplianceRequirementV5 {
            id: "R1".into(),
            name: "Req 1".into(),
    ...
    fn test_assessment_new() {
        let assessment = ComplianceAssessmentV5::new("fw-1".into());
        assert_eq!(assessment.framework_id, "fw-1");
        assert_eq!(assessment.status, AssessmentStatusV5::Pending);
    ...
    fn test_assessment_add_finding() {
        let mut assessment = ComplianceAssessmentV5::new("fw-1".into());
        let finding = make_finding("req-1", FindingStatusV5::Compliant);
    ...
    fn test_assessment_complete() {
        ...
        assert_eq!(assessment.status, AssessmentStatusV5::Passed);
    ...
    fn test_assessment_complete_failed() {
        let mut assessment = ComplianceAssessmentV5::new("fw-1".into());
        let finding = make_finding("req-1", FindingStatusV5::NonCompliant);
        assessment.add_finding(finding);
        assessment.complete(0);
        assert_eq!(assessment.status, AssessmentStatusV5::Failed);
    }

    #[test]
    fn test_finding_is_compliant() {
        let f = make_finding("R1", FindingStatusV5::Compliant);
        assert!(f.is_compliant());
        let f = make_finding("R1", FindingStatusV5::NotApplicable);
        assert!(f.is_compliant());
        let f = make_finding("R1", FindingStatusV5::NonCompliant);
        assert!(!f.is_compliant());
    }

    #[test]
    fn test_finding_tracker_new() {
        let tracker = FindingTrackerV5::new();
    ...
    fn test_finding_tracker_add_finding() {
        let mut tracker = FindingTrackerV5::new();
        let finding = make_finding("req-1", FindingStatusV5::NonCompliant);
    ...
    fn test_finding_tracker_overdue() {
        let mut tracker = FindingTrackerV5::new();
        let finding = make_finding("f-1", FindingStatusV5::NonCompliant);
        tracker.add_finding(finding);
    ...
    fn test_finding_tracker_open_findings() {
        let mut tracker = FindingTrackerV5::new();
        tracker.add_finding(make_finding("f-1", FindingStatusV5::NonCompliant));
        tracker.add_finding(make_finding("f-2", FindingStatusV5::Compliant));
    ...
    fn test_finding_tracker_update_status() {
        let mut tracker = FindingTrackerV5::new();
        let mut finding = make_finding("f-1", FindingStatusV5::NonCompliant);
        finding.id = "f-1".into();
        tracker.add_finding(finding);
        tracker
            .update_finding_status("f-1", FindingStatusV5::Compliant, Some("user-1".into()))
            .unwrap();
        assert_eq!(tracker.findings[0].status, FindingStatusV5::Compliant);
    ...
    fn test_finding_tracker_get_history() {
        ...
        tracker.add_finding(finding);
        tracker
            .update_finding_status("f-1", FindingStatusV5::Partial, None)
            .unwrap();
        tracker
            .update_finding_status("f-1", FindingStatusV5::Compliant, None)
            .unwrap();
    ...
    fn test_assess_all_compliant() {
        ...
        let findings = vec![make_finding("R1", FindingStatusV5::Compliant)];
        let result = ComplianceAssessorV5::assess(&fw, &findings);
        assert_eq!(result.score, 100);
        assert_eq!(result.status, AssessmentStatusV5::Passed);
    ...
    fn test_assess_some_non_compliant() {
        ...
        let findings = vec![
            make_finding("R1", FindingStatusV5::Compliant),
            make_finding("R2", FindingStatusV5::NonCompliant),
        ];
        let result = ComplianceAssessorV5::assess(&fw, &findings);
        assert_eq!(result.score, 50);
        assert_eq!(result.status, AssessmentStatusV5::Failed);
    ...
    fn test_scoring_engine_weighted() {
        ...
        let score =
            ComplianceScoringEngineV5::calculate_framework_score(&requirements, &findings);
    ...
    fn test_soc2_framework() {
        let fw = create_soc2_framework_v5();
    ...
    fn test_iso27001_framework() {
        let fw = create_iso27001_framework_v5();
