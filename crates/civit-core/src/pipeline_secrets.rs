//! Pipeline Secrets: Advanced secrets management with environment support,
...
impl From<SecretRow> for PipelineSecret {
...
pub struct PipelineSecretsService {
    pool: PgPool,
}

impl PipelineSecretsService {
    ...
    ) -> Result<Vec<PipelineSecret>, sqlx::Error> {
    ...
    pub async fn get_secret(
        ...
        name: &str,
        environment: &str,
    ) -> Result<Option<PipelineSecret>, sqlx::Error> {
    ...
    ) -> Result<PipelineSecret, sqlx::Error> {
...
mod tests {
    ...
    #[test]
    fn test_pipeline_secret_serialize() {
        let secret = PipelineSecret {
            id: Uuid::new_v4(),
            repo_id: Uuid::new_v4(),
