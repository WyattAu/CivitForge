...
pub struct ResidencyReportEntryV13 {
    pub id: Uuid,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ResidencyComplianceEntryV13 {
    pub id: Uuid,
    pub rule_id: Uuid,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ViolationResolutionV13 {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ResidencyAuditLogEntryV13 {
    pub id: Uuid,
    pub action: String,
...
pub struct DataResidencyV15Service {
    pool: PgPool,
}

impl DataResidencyV15Service {
    ...
    pub async fn generate_report(
        &self,
        report_type: &str,
    ) -> Result<ResidencyReportEntryV13, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct ReportRow {
            id: Uuid,
            report_type: String,
    ...
    ) -> Result<Vec<ResidencyReportEntryV13>, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct ReportRow {
            id: Uuid,
            report_type: String,
    ...
    pub async fn track_compliance(
        &self,
        rule_id: Uuid,
    ) -> Result<ResidencyComplianceEntryV13, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        ...
        Ok(ResidencyComplianceEntryV13 {
            id: row.id,
            rule_id: row.rule_id,
    ...
    pub async fn get_compliance_by_rule(
        &self,
        rule_id: Uuid,
    ) -> Result<Vec<ResidencyComplianceEntryV13>, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct ComplianceRow {
            id: Uuid,
            rule_id: Uuid,
        ...
        Ok(rows
            .into_iter()
            .map(|r| ResidencyComplianceEntryV13 {
                id: r.id,
                rule_id: r.rule_id,
    ...
    ) -> Result<ViolationResolutionV13, sqlx::Error> {
        let _ = sqlx::query(
    ...
    pub async fn log_audit(
        ...
        user_id: Option<Uuid>,
        details: serde_json::Value,
    ) -> Result<ResidencyAuditLogEntryV13, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct AuditRow {
            id: Uuid,
            action: String,
