...
pub struct ReplicationConfigEntryV13 {
    pub id: Uuid,
    pub replica_id: Uuid,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ReplicationAlertEntryV13 {
    pub id: Uuid,
    pub replica_id: Uuid,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ReplicationMonitoringResultV13 {
    pub replica_id: Uuid,
    pub replica_name: String,
    pub lag_ms: i32,
    pub status: String,
    pub healthy: bool,
    pub alerts: Vec<ReplicationAlertEntryV13>,
    pub config: Vec<ReplicationConfigEntryV13>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FailoverTestResultV13 {
    pub replica_id: Uuid,
    pub success: bool,
    pub duration_ms: i32,
    pub error_message: Option<String>,
    pub tested_at: DateTime<Utc>,
    pub steps: Vec<FailoverTestStepV13>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FailoverTestStepV13 {
...
pub struct DatabaseReplicationV15Service {
    pool: PgPool,
}

impl DatabaseReplicationV15Service {
    ...
    ) -> Result<ReplicationConfigEntryV13, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct ConfigRow {
            id: Uuid,
            replica_id: Uuid,
    ...
    pub async fn get_config(
        ...
        replica_id: Uuid,
        config_key: &str,
    ) -> Result<Option<ReplicationConfigEntryV13>, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct ConfigRow {
            id: Uuid,
            replica_id: Uuid,
        ...
        Ok(row.map(|r| ReplicationConfigEntryV13 {
            id: r.id,
    ...
    pub async fn get_all_config(
        &self,
        replica_id: Uuid,
    ) -> Result<Vec<ReplicationConfigEntryV13>, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct ConfigRow {
            id: Uuid,
            replica_id: Uuid,
        ...
        Ok(rows
            .into_iter()
            .map(|r| ReplicationConfigEntryV13 {
                id: r.id,
                replica_id: r.replica_id,
                config_key: r.config_key,
                config_value: r.config_value,
    ...
    pub async fn create_alert(
        ...
        alert_type: &str,
        threshold: f64,
    ) -> Result<ReplicationAlertEntryV13, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct AlertRow {
            id: Uuid,
            replica_id: Uuid,
    ...
    pub async fn get_alerts(
        &self,
        replica_id: Uuid,
    ) -> Result<Vec<ReplicationAlertEntryV13>, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct AlertRow {
            id: Uuid,
            replica_id: Uuid,
        ...
        Ok(rows
            .into_iter()
            .map(|r| ReplicationAlertEntryV13 {
                id: r.id,
                replica_id: r.replica_id,
    ...
    pub async fn monitor_replication(&self) -> Result<Vec<ReplicationMonitoringResultV13>, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct ReplicaRow {
            id: Uuid,
            name: String,
        ...
        for replica in replicas {
            ...
            results.push(ReplicationMonitoringResultV13 {
    ...
    pub async fn test_failover(
        &self,
        replica_id: Uuid,
    ) -> Result<FailoverTestResultV13, sqlx::Error> {
        let start = Utc::now();
        ...
        if replica_exists.is_none() {
            return Ok(FailoverTestResultV13 {
                replica_id,
                success: false,
                duration_ms: 0,
        ...
        steps.push(FailoverTestStepV13 {
