...
pub struct ReplicationConfigEntryV18 {
    pub id: Uuid,
    pub replica_id: Uuid,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ReplicationAlertEntryV18 {
    pub id: Uuid,
    pub replica_id: Uuid,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ReplicationMonitoringResultV18 {
    pub replica_id: Uuid,
    pub replica_name: String,
    pub lag_ms: i32,
    pub status: String,
    pub healthy: bool,
    pub alerts: Vec<ReplicationAlertEntryV18>,
    pub config: Vec<ReplicationConfigEntryV18>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FailoverTestResultV18 {
    pub replica_id: Uuid,
    pub success: bool,
    pub duration_ms: i32,
    pub error_message: Option<String>,
    pub tested_at: DateTime<Utc>,
    pub steps: Vec<FailoverTestStepV18>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FailoverTestStepV18 {
...
pub struct DatabaseReplicationV20Service {
    pool: PgPool,
}

impl DatabaseReplicationV20Service {
    ...
    ) -> Result<ReplicationConfigEntryV18, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct ConfigRow {
            id: Uuid,
            replica_id: Uuid,
    ...
    pub async fn get_config(
        ...
        replica_id: Uuid,
        config_key: &str,
    ) -> Result<Option<ReplicationConfigEntryV18>, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct ConfigRow {
            id: Uuid,
            replica_id: Uuid,
        ...
        Ok(row.map(|r| ReplicationConfigEntryV18 {
            id: r.id,
    ...
    pub async fn get_all_config(
        &self,
        replica_id: Uuid,
    ) -> Result<Vec<ReplicationConfigEntryV18>, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct ConfigRow {
            id: Uuid,
            replica_id: Uuid,
        ...
        Ok(rows
            .into_iter()
            .map(|r| ReplicationConfigEntryV18 {
                id: r.id,
                replica_id: r.replica_id,
                config_key: r.config_key,
                config_value: r.config_value,
    ...
    pub async fn create_alert(
        ...
        alert_type: &str,
        threshold: f64,
    ) -> Result<ReplicationAlertEntryV18, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct AlertRow {
            id: Uuid,
            replica_id: Uuid,
    ...
    pub async fn get_alerts(
        &self,
        replica_id: Uuid,
    ) -> Result<Vec<ReplicationAlertEntryV18>, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct AlertRow {
            id: Uuid,
            replica_id: Uuid,
        ...
        Ok(rows
            .into_iter()
            .map(|r| ReplicationAlertEntryV18 {
                id: r.id,
                replica_id: r.replica_id,
    ...
    pub async fn monitor_replication(&self) -> Result<Vec<ReplicationMonitoringResultV18>, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct ReplicaRow {
            id: Uuid,
            name: String,
        ...
        for replica in replicas {
            ...
            results.push(ReplicationMonitoringResultV18 {
    ...
    pub async fn test_failover(
        &self,
        replica_id: Uuid,
    ) -> Result<FailoverTestResultV18, sqlx::Error> {
        let start = Utc::now();
        ...
        if replica_exists.is_none() {
            return Ok(FailoverTestResultV18 {
                replica_id,
                success: false,
                duration_ms: 0,
        ...
        steps.push(FailoverTestStepV18 {
