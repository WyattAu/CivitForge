...
pub struct ComplianceRequirementRecordV18 {
    pub id: String,
    pub framework_id: String,
    pub requirement_id: String,
    pub description: String,
    pub severity: RequirementSeverityV18,
...
impl ComplianceRequirementRecordV18 {
    pub fn new(
        framework_id: String,
        ...
        Self {
            ...
            requirement_id,
            description,
            severity: RequirementSeverityV18::Medium,
    ...
    pub fn with_severity(mut self, severity: RequirementSeverityV18) -> Self {
    ...
    pub fn risk_weight(&self) -> f64 {
        match self.severity {
            RequirementSeverityV18::Critical => 4.0,
            RequirementSeverityV18::High => 3.0,
            RequirementSeverityV18::Medium => 2.0,
            RequirementSeverityV18::Low => 1.0,
        }
    }
}
...
pub enum RequirementSeverityV18 {
    Critical,
    High,
    Medium,
    Low,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ComplianceEvidenceV18 {
    pub id: String,
    pub requirement_id: String,
    pub assessment_id: String,
    pub evidence_type: EvidenceTypeV18,
    pub content: HashMap<String, serde_json::Value>,
    pub collected_by: Option<String>,
    pub collected_at: DateTime<Utc>,
}

impl ComplianceEvidenceV18 {
    pub fn new(
        requirement_id: String,
        assessment_id: String,
        evidence_type: EvidenceTypeV18,
    ) -> Self {
        Self {
            id: uuid::Uuid::new_v4().to_string(),
            requirement_id,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ComplianceCheckResultV18 {
    pub id: String,
    pub requirement_id: String,
    pub assessment_id: String,
    pub status: CheckStatusV18,
    pub result_details: HashMap<String, serde_json::Value>,
    pub score: u32,
    pub executed_at: DateTime<Utc>,
}

impl ComplianceCheckResultV18 {
    pub fn new(
        requirement_id: String,
        assessment_id: String,
        status: CheckStatusV18,
    ) -> Self {
        Self {
            id: uuid::Uuid::new_v4().to_string(),
            requirement_id,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ComplianceFrameworkV18 {
    pub id: String,
    pub name: String,
    pub version: String,
    pub description: String,
    pub requirements: Vec<ComplianceRequirementV18>,
    pub enabled: bool,
    pub created_at: DateTime<Utc>,
    pub updated_at: DateTime<Utc>,
}

impl ComplianceFrameworkV18 {
    ...
    pub fn add_requirement(&mut self, requirement: ComplianceRequirementV18) {
        self.requirements.push(requirement);
    }

    pub fn mandatory_requirements(&self) -> Vec<&ComplianceRequirementV18> {
        self.requirements.iter().filter(|r| r.mandatory).collect()
    }

    pub fn requirements_by_category(&self, category: &str) -> Vec<&ComplianceRequirementV18> {
        self.requirements
            .iter()
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ComplianceRequirementV18 {
    pub id: String,
    pub name: String,
    pub description: String,
    pub category: String,
    pub mandatory: bool,
    pub verification_method: VerificationMethodV18,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "snake_case")]
pub enum VerificationMethodV18 {
    Automated,
    Manual,
    Hybrid,
    Inherited,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ComplianceAssessmentV18 {
    pub id: String,
    pub framework_id: String,
    pub repo_id: Option<String>,
    pub status: AssessmentStatusV18,
    pub findings: Vec<ComplianceFindingV18>,
    pub score: u32,
    pub assessor_id: Option<String>,
    pub started_at: DateTime<Utc>,
    pub completed_at: Option<DateTime<Utc>>,
    pub history: Vec<AssessmentSnapshotV18>,
}

impl ComplianceAssessmentV18 {
    pub fn new(framework_id: String) -> Self {
        Self {
            id: uuid::Uuid::new_v4().to_string(),
            framework_id,
            repo_id: None,
            status: AssessmentStatusV18::Pending,
            findings: Vec::new(),
            score: 0,
            assessor_id: None,
            started_at: Utc::now(),
    ...
    pub fn add_finding(&mut self, finding: ComplianceFindingV18) {
        self.findings.push(finding);
        self.snapshot_history();
    }

    pub fn complete(&mut self, score: u32) {
        self.status = if self.findings.iter().any(|f| f.status == FindingStatusV18::NonCompliant) {
            AssessmentStatusV18::Failed
        } else if self.findings.iter().any(|f| f.status == FindingStatusV18::Partial) {
            AssessmentStatusV18::Partial
        } else {
            AssessmentStatusV18::Passed
        };
        self.score = score;
    ...
    pub fn compliance_rate(&self) -> f64 {
        ...
        let compliant = self
            .findings
            .iter()
            .filter(|f| f.status == FindingStatusV18::Compliant || f.status == FindingStatusV18::NotApplicable)
            .count();
    ...
    pub fn non_compliant_count(&self) -> usize {
        self.findings
            .iter()
            .filter(|f| f.status == FindingStatusV18::NonCompliant)
            .count()
    }

    fn snapshot_history(&mut self) {
        self.history.push(AssessmentSnapshotV18 {
            status: self.status,
            score: self.score,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct AssessmentSnapshotV18 {
    pub status: AssessmentStatusV18,
    pub score: u32,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ComplianceFindingV18 {
    pub id: String,
    pub requirement_id: String,
    pub status: FindingStatusV18,
    pub details: String,
...
impl ComplianceFindingV18 {
    pub fn is_compliant(&self) -> bool {
        self.status == FindingStatusV18::Compliant || self.status == FindingStatusV18::NotApplicable
    }
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FindingTrackerV18 {
    pub findings: Vec<ComplianceFindingV18>,
    ...
    pub history: Vec<FindingHistoryEntryV18>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FindingHistoryEntryV18 {
    pub finding_id: String,
    pub old_status: FindingStatusV18,
    pub new_status: FindingStatusV18,
    pub changed_by: Option<String>,
    pub changed_at: DateTime<Utc>,
}

impl FindingTrackerV18 {
    pub fn new() -> Self {
        Self {
            findings: Vec::new(),
    ...
    pub fn update_finding_status(
        ...
        self.history.push(FindingHistoryEntryV18 {
    ...
    pub fn overdue_findings(&self) -> Vec<&ComplianceFindingV18> {
        let now = Utc::now();
        self.findings
            .iter()
            .filter(|f| {
    ...
    pub fn open_findings(&self) -> Vec<&ComplianceFindingV18> {
        self.findings
            .iter()
            .filter(|f| f.status == FindingStatusV18::NonCompliant || f.status == FindingStatusV18::Partial)
            .collect()
    }

    pub fn findings_by_severity(&self, status: FindingStatusV18) -> Vec<&ComplianceFindingV18> {
    ...
    pub fn compute_severity_scores(&mut self) -> HashMap<String, u32> {
        ...
        for finding in &self.findings {
            ...
            *scores.entry(category).or_insert(0) += match finding.status {
                FindingStatusV18::NonCompliant => 10,
                FindingStatusV18::Partial => 5,
                FindingStatusV18::Compliant => 0,
                FindingStatusV18::NotApplicable => 0,
            };
        }
    ...
    pub fn finding_history(&self, finding_id: &str) -> Vec<&FindingHistoryEntryV18> {
        self.history
            .iter()
...
impl Default for FindingTrackerV18 {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct ComplianceScoringEngineV18;

impl ComplianceScoringEngineV18 {
    pub fn calculate_framework_score(
        requirements: &[ComplianceRequirementRecordV18],
        check_results: &[ComplianceCheckResultV18],
    ) -> ComplianceScoreV18 {
        let total = requirements.len() as u32;
        if total == 0 {
            return ComplianceScoreV18 {
                overall: 100,
        ...
        for result in check_results {
            match result.status {
                CheckStatusV18::Passed => passed += 1,
                CheckStatusV18::Failed => failed += 1,
                CheckStatusV18::Skipped => skipped += 1,
                CheckStatusV18::Inherited => inherited += 1,
                _ => {}
            }
        }
    ...
    pub fn calculate_weighted_score(
        ...
        let earned_weight: f64 = requirements.iter().zip(check_results.iter()).map(|(req, res)| {
            ...
            if res.status == CheckStatusV18::Passed || res.status == CheckStatusV18::Inherited {
                weight
            } else {
                0.0
            }
...
pub struct ComplianceAssessorV18;

impl ComplianceAssessorV18 {
    pub fn assess(
        framework: &ComplianceFrameworkV18,
        findings: &[ComplianceFindingV18],
    ) -> AssessmentResultV18 {
        let total_requirements = framework.requirements.len() as u32;
        if total_requirements == 0 {
            return AssessmentResultV18 {
                score: 100,
                status: AssessmentStatusV18::Passed,
                compliant_count: 0,
        ...
        for finding in findings {
            match finding.status {
                FindingStatusV18::Compliant => compliant += 1,
                FindingStatusV18::NonCompliant => non_compliant += 1,
                FindingStatusV18::Partial => partial += 1,
                FindingStatusV18::NotApplicable => not_applicable += 1,
            }
        }
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct AssessmentResultV18 {
    pub score: u32,
    pub status: AssessmentStatusV18,
...
pub fn create_soc2_framework_v18() -> ComplianceFrameworkV18 {
    let mut framework = ComplianceFrameworkV18::new(
        "SOC 2".into(),
        "Service Organization Control 2".into(),
    );
    framework.add_requirement(ComplianceRequirementV18 {
        id: "CC6.1".into(),
        name: "Logical Access Controls".into(),
        description: "Implement logical access security controls".into(),
        category: "Security".into(),
        mandatory: true,
        verification_method: VerificationMethodV18::Automated,
    });
    framework.add_requirement(ComplianceRequirementV18 {
        id: "CC6.6".into(),
        ...
        category: "Security".into(),
        mandatory: true,
        verification_method: VerificationMethodV18::Hybrid,
    });
    framework.add_requirement(ComplianceRequirementV18 {
        id: "CC7.1".into(),
    ...
    framework.add_requirement(ComplianceRequirementV18 {
        ...
        mandatory: true,
        verification_method: VerificationMethodV18::Manual,
    });
    framework
}

pub fn create_iso27001_framework_v18() -> ComplianceFrameworkV18 {
    let mut framework = ComplianceFrameworkV18::new(
        "ISO 27001".into(),
...
mod tests {
    ...
    fn make_finding(requirement_id: &str, status: FindingStatusV18) -> ComplianceFindingV18 {
        ComplianceFindingV18 {
            id: uuid::Uuid::new_v4().to_string(),
    ...
    fn test_compliance_framework_v18_new() {
        let fw = ComplianceFrameworkV18::new("Test".into(), "Description".into());
    ...
    fn test_compliance_framework_v18_with_version() {
        let fw = ComplianceFrameworkV18::new("Test".into(), "Desc".into())
            .with_version("17.0");
    ...
    fn test_compliance_framework_v18_increment_version() {
        let mut fw = ComplianceFrameworkV18::new("Test".into(), "Desc".into());
    ...
    fn test_add_requirement() {
        let mut fw = ComplianceFrameworkV18::new("Test".into(), "Desc".into());
        fw.add_requirement(ComplianceRequirementV18 {
            id: "R1".into(),
            name: "Req 1".into(),
    ...
    fn test_assessment_v18_new() {
        let assessment = ComplianceAssessmentV18::new("fw-1".into());
        assert_eq!(assessment.framework_id, "fw-1");
        assert_eq!(assessment.status, AssessmentStatusV18::Pending);
    ...
    fn test_assessment_v18_add_finding() {
        let mut assessment = ComplianceAssessmentV18::new("fw-1".into());
        let finding = ComplianceFindingV18 {
            id: uuid::Uuid::new_v4().to_string(),
            requirement_id: "req-1".into(),
            status: FindingStatusV18::Compliant,
            details: "Test".into(),
            evidence: None,
            remediation: None,
        };
    ...
    fn test_assessment_v18_complete() {
        ...
        assert_eq!(assessment.status, AssessmentStatusV18::Passed);
    ...
    fn test_assessment_v18_complete_failed() {
        ...
        let finding = ComplianceFindingV18 {
            id: uuid::Uuid::new_v4().to_string(),
            requirement_id: "req-1".into(),
            status: FindingStatusV18::NonCompliant,
            details: "Test".into(),
            evidence: None,
            remediation: None,
        };
        ...
        assert_eq!(assessment.status, AssessmentStatusV18::Failed);
    }

    #[test]
    fn test_assessment_compliance_rate() {
        let mut assessment = ComplianceAssessmentV18::new("fw-1".into());
        assessment.add_finding(make_finding("R1", FindingStatusV18::Compliant));
        assessment.add_finding(make_finding("R2", FindingStatusV18::NonCompliant));
    ...
    fn test_assessment_non_compliant_count() {
        ...
        assessment.add_finding(make_finding("R1", FindingStatusV18::Compliant));
        assessment.add_finding(make_finding("R2", FindingStatusV18::NonCompliant));
        assessment.add_finding(make_finding("R3", FindingStatusV18::NonCompliant));
        assert_eq!(assessment.non_compliant_count(), 2);
    }

    #[test]
    fn test_finding_is_compliant() {
        let f = make_finding("R1", FindingStatusV18::Compliant);
        assert!(f.is_compliant());
        let f = make_finding("R1", FindingStatusV18::NotApplicable);
        assert!(f.is_compliant());
        let f = make_finding("R1", FindingStatusV18::NonCompliant);
        assert!(!f.is_compliant());
    }

    #[test]
    fn test_finding_tracker_v18_new() {
        let tracker = FindingTrackerV18::new();
    ...
    fn test_finding_tracker_v18_add_finding() {
        let mut tracker = FindingTrackerV18::new();
        let finding = ComplianceFindingV18 {
            id: "f-1".into(),
            requirement_id: "req-1".into(),
            status: FindingStatusV18::NonCompliant,
    ...
    fn test_finding_tracker_v18_update_status() {
        ...
        tracker.add_finding(finding);
        tracker
            .update_finding_status("f-1", FindingStatusV18::Compliant, Some("user-1".into()))
            .unwrap();
        assert_eq!(tracker.findings[0].status, FindingStatusV18::Compliant);
        assert_eq!(tracker.history.len(), 1);
        assert_eq!(tracker.history[0].old_status, FindingStatusV18::NonCompliant);
        assert_eq!(tracker.history[0].new_status, FindingStatusV18::Compliant);
    }
    ...
    fn test_finding_tracker_v18_finding_history() {
        ...
        tracker.add_finding(finding);
        tracker
            .update_finding_status("f-1", FindingStatusV18::Partial, None)
            .unwrap();
        tracker
            .update_finding_status("f-1", FindingStatusV18::Compliant, None)
            .unwrap();
    ...
    fn test_finding_tracker_v18_findings_by_status() {
        let mut tracker = FindingTrackerV18::new();
        tracker.add_finding(make_finding("R1", FindingStatusV18::NonCompliant));
        tracker.add_finding(make_finding("R2", FindingStatusV18::Compliant));
        tracker.add_finding(make_finding("R3", FindingStatusV18::NonCompliant));
        assert_eq!(tracker.findings_by_severity(FindingStatusV18::NonCompliant).len(), 2);
        assert_eq!(tracker.findings_by_severity(FindingStatusV18::Compliant).len(), 1);
    }
    ...
    fn test_finding_tracker_v18_compute_severity_scores() {
        ...
        let f2 = ComplianceFindingV18 {
            id: "f-2".into(),
            requirement_id: "CC6.1".into(),
            status: FindingStatusV18::Partial,
            details: "Test".into(),
            evidence: None,
            remediation: None,
        };
    ...
    fn test_assess_all_compliant() {
        ...
        let findings = vec![
            make_finding("R1", FindingStatusV18::Compliant),
            make_finding("R2", FindingStatusV18::Compliant),
        ];
        let result = ComplianceAssessorV18::assess(&fw, &findings);
        assert_eq!(result.score, 100);
        assert_eq!(result.status, AssessmentStatusV18::Passed);
    ...
    fn test_assess_some_non_compliant() {
        ...
        let findings = vec![
            make_finding("R1", FindingStatusV18::Compliant),
            make_finding("R2", FindingStatusV18::NonCompliant),
        ];
        let result = ComplianceAssessorV18::assess(&fw, &findings);
        assert_eq!(result.score, 50);
        assert_eq!(result.status, AssessmentStatusV18::Failed);
    ...
    fn test_assess_with_not_applicable() {
        ...
        let findings = vec![
            make_finding("R1", FindingStatusV18::Compliant),
            make_finding("R2", FindingStatusV18::NotApplicable),
        ];
        let result = ComplianceAssessorV18::assess(&fw, &findings);
        assert_eq!(result.score, 100);
        assert_eq!(result.status, AssessmentStatusV18::Passed);
    ...
    fn test_assess_empty_requirements() {
        let fw = ComplianceFrameworkV18::new("Test".into(), "Desc".into());
        let result = ComplianceAssessorV18::assess(&fw, &[]);
        assert_eq!(result.score, 100);
        assert_eq!(result.status, AssessmentStatusV18::Passed);
    }
    ...
    fn test_assess_partial() {
        ...
        let findings = vec![make_finding("R1", FindingStatusV18::Partial)];
        let result = ComplianceAssessorV18::assess(&fw, &findings);
        assert_eq!(result.status, AssessmentStatusV18::Partial);
    }
    ...
    fn test_compliance_scoring_engine_v18() {
        let requirements = vec![
            ComplianceRequirementRecordV18::new("fw".into(), "R1".into(), "".into()),
            ComplianceRequirementRecordV18::new("fw".into(), "R2".into(), "".into()),
        ];
        let check_results = vec![
            ComplianceCheckResultV18::new("R1".into(), "a".into(), CheckStatusV18::Passed),
            ComplianceCheckResultV18::new("R2".into(), "a".into(), CheckStatusV18::Failed),
        ];
        let score = ComplianceScoringEngineV18::calculate_framework_score(&requirements, &check_results);
    ...
    fn test_compliance_scoring_engine_v18_weighted() {
        let requirements = vec![
            ComplianceRequirementRecordV18::new("fw".into(), "R1".into(), "".into())
                .with_severity(RequirementSeverityV18::Critical),
            ComplianceRequirementRecordV18::new("fw".into(), "R2".into(), "".into())
                .with_severity(RequirementSeverityV18::Low),
        ];
        let check_results = vec![
            ComplianceCheckResultV18::new("R1".into(), "a".into(), CheckStatusV18::Passed),
            ComplianceCheckResultV18::new("R2".into(), "a".into(), CheckStatusV18::Failed),
        ];
        let score = ComplianceScoringEngineV18::calculate_weighted_score(&requirements, &check_results);
    ...
    fn test_compliance_scoring_engine_v18_inherited() {
        ...
        let check_results = vec![
            ComplianceCheckResultV18::new("R1".into(), "a".into(), CheckStatusV18::Passed),
            ComplianceCheckResultV18::new("R2".into(), "a".into(), CheckStatusV18::Inherited),
        ];
        let score = ComplianceScoringEngineV18::calculate_framework_score(&requirements, &check_results);
        assert_eq!(score.overall, 100);
    ...
    fn test_requirement_risk_weight() {
        let req = ComplianceRequirementRecordV18::new("fw".into(), "R1".into(), "".into())
            .with_severity(RequirementSeverityV18::Critical);
