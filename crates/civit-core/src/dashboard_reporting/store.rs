...
// V13: Dashboard sharing v10 and report scheduling v11

impl DashboardReportingService {
    pub async fn create_dashboard_share_v10(
        &self,
        input: CreateDashboardShareV10,
    ) -> Result<DashboardShareV10, sqlx::Error> {
        let row = sqlx::query_as::<_, DashboardShareV10Row>(
            r#"INSERT INTO dashboard_shares_v10 (dashboard_id, user_id, permission)
             VALUES ($1, $2, $3)
             ON CONFLICT (dashboard_id, user_id) DO UPDATE SET permission = $3
             RETURNING id, dashboard_id, user_id, permission, created_at"#,
        )
    ...
    pub async fn get_dashboard_share_v10(
        &self,
        id: uuid::Uuid,
    ) -> Result<Option<DashboardShareV10>, sqlx::Error> {
        let row = sqlx::query_as::<_, DashboardShareV10Row>(
            r#"SELECT id, dashboard_id, user_id, permission, created_at
             FROM dashboard_shares_v10 WHERE id = $1"#,
        )
        .bind(id)
        .fetch_optional(&self.pool)
        .await?;
    ...
    pub async fn list_dashboard_shares_v10(
        &self,
        dashboard_id: uuid::Uuid,
    ) -> Result<Vec<DashboardShareV10>, sqlx::Error> {
        let rows = sqlx::query_as::<_, DashboardShareV10Row>(
            r#"SELECT id, dashboard_id, user_id, permission, created_at
             FROM dashboard_shares_v10 WHERE dashboard_id = $1
             ORDER BY created_at DESC"#,
        )
        .bind(dashboard_id)
        .fetch_all(&self.pool)
    ...
    pub async fn delete_dashboard_share_v10(
        &self,
        id: uuid::Uuid,
    ) -> Result<bool, sqlx::Error> {
        let result = sqlx::query("DELETE FROM dashboard_shares_v10 WHERE id = $1")
            .bind(id)
            .execute(&self.pool)
            .await?;
        Ok(result.rows_affected() > 0)
    ...
    pub async fn create_report_schedule_v11(
        &self,
        input: CreateReportScheduleV11,
    ) -> Result<ReportScheduleV11, sqlx::Error> {
        let row = sqlx::query_as::<_, ReportScheduleV11Row>(
            r#"INSERT INTO report_schedules_v11 (report_id, cron_expression, enabled, next_run_at)
             VALUES ($1, $2, $3, $4)
             RETURNING id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at"#,
        )
        .bind(input.report_id)
    ...
    pub async fn get_report_schedule_v11(
        &self,
        id: uuid::Uuid,
    ) -> Result<Option<ReportScheduleV11>, sqlx::Error> {
        let row = sqlx::query_as::<_, ReportScheduleV11Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v11 WHERE id = $1"#,
        )
        .bind(id)
        .fetch_optional(&self.pool)
        .await?;
    ...
    pub async fn list_report_schedules_v11(
        &self,
        report_id: uuid::Uuid,
    ) -> Result<Vec<ReportScheduleV11>, sqlx::Error> {
        let rows = sqlx::query_as::<_, ReportScheduleV11Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v11 WHERE report_id = $1
             ORDER BY created_at DESC"#,
        )
        .bind(report_id)
        .fetch_all(&self.pool)
    ...
    pub async fn update_report_schedule_v11(
        &self,
        id: uuid::Uuid,
        input: UpdateReportScheduleV11,
    ) -> Result<ReportScheduleV11, sqlx::Error> {
        let row = sqlx::query_as::<_, ReportScheduleV11Row>(
            r#"UPDATE report_schedules_v11 SET
             cron_expression = COALESCE($2, cron_expression),
             enabled = COALESCE($3, enabled),
             next_run_at = COALESCE($4, next_run_at)
             WHERE id = $1
    ...
    pub async fn delete_report_schedule_v11(
        &self,
        id: uuid::Uuid,
    ) -> Result<bool, sqlx::Error> {
        let result = sqlx::query("DELETE FROM report_schedules_v11 WHERE id = $1")
            .bind(id)
            .execute(&self.pool)
            .await?;
        Ok(result.rows_affected() > 0)
    ...
    pub async fn list_due_report_schedules_v11(
        &self,
    ) -> Result<Vec<ReportScheduleV11>, sqlx::Error> {
        let rows = sqlx::query_as::<_, ReportScheduleV11Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v11
...
impl From<DashboardShareV10Row> for DashboardShareV10 {
    fn from(row: DashboardShareV10Row) -> Self {
        DashboardShareV10 {
            id: row.id,
            dashboard_id: row.dashboard_id,
            user_id: row.user_id,
...
impl From<ReportScheduleV11Row> for ReportScheduleV11 {
    fn from(row: ReportScheduleV11Row) -> Self {
        ReportScheduleV11 {
            id: row.id,
            report_id: row.report_id,
            cron_expression: row.cron_expression,
...
impl From<DashboardShareV11Row> for DashboardShareV11 {
    fn from(row: DashboardShareV11Row) -> Self {
        DashboardShareV11 {
            id: row.id,
            dashboard_id: row.dashboard_id,
            user_id: row.user_id,
...
impl From<ReportScheduleV12Row> for ReportScheduleV12 {
    fn from(row: ReportScheduleV12Row) -> Self {
        ReportScheduleV12 {
            id: row.id,
            report_id: row.report_id,
            cron_expression: row.cron_expression,
...
impl From<DashboardShareV12Row> for DashboardShareV12 {
    fn from(row: DashboardShareV12Row) -> Self {
        DashboardShareV12 {
            id: row.id,
            dashboard_id: row.dashboard_id,
            user_id: row.user_id,
...
impl From<ReportScheduleV13Row> for ReportScheduleV13 {
    fn from(row: ReportScheduleV13Row) -> Self {
        ReportScheduleV13 {
            id: row.id,
            report_id: row.report_id,
            cron_expression: row.cron_expression,
...
impl From<DashboardShareV13Row> for DashboardShareV13 {
    fn from(row: DashboardShareV13Row) -> Self {
        DashboardShareV13 {
            id: row.id,
            dashboard_id: row.dashboard_id,
            user_id: row.user_id,
...
impl From<ReportScheduleV14Row> for ReportScheduleV14 {
    fn from(row: ReportScheduleV14Row) -> Self {
        ReportScheduleV14 {
            id: row.id,
            report_id: row.report_id,
            cron_expression: row.cron_expression,
...
impl DashboardReportingService {
    // V14: Dashboard sharing v11

    pub async fn share_dashboard_v11(
        &self,
        dashboard_id: uuid::Uuid,
        user_id: uuid::Uuid,
        permission: &str,
    ) -> Result<DashboardShareV11, sqlx::Error> {
        let row = sqlx::query_as::<_, DashboardShareV11Row>(
            r#"INSERT INTO dashboard_shares_v11 (dashboard_id, user_id, permission)
             VALUES ($1, $2, $3)
             ON CONFLICT (dashboard_id, user_id) DO UPDATE SET permission = $3
             RETURNING id, dashboard_id, user_id, permission, created_at"#,
        )
    ...
    pub async fn get_dashboard_shares_v11(
        &self,
        dashboard_id: uuid::Uuid,
    ) -> Result<Vec<DashboardShareV11>, sqlx::Error> {
        let rows = sqlx::query_as::<_, DashboardShareV11Row>(
            r#"SELECT id, dashboard_id, user_id, permission, created_at
             FROM dashboard_shares_v11 WHERE dashboard_id = $1
             ORDER BY created_at DESC"#,
        )
        .bind(dashboard_id)
        .fetch_all(&self.pool)
    ...
    pub async fn remove_dashboard_share_v11(
        &self,
        dashboard_id: uuid::Uuid,
        user_id: uuid::Uuid,
    ) -> Result<bool, sqlx::Error> {
        let result = sqlx::query(
            "DELETE FROM dashboard_shares_v11 WHERE dashboard_id = $1 AND user_id = $2",
        )
        .bind(dashboard_id)
        .bind(user_id)
        .execute(&self.pool)
    ...
    pub async fn get_dashboards_shared_with_user_v11(
        &self,
        user_id: uuid::Uuid,
    ) -> Result<Vec<Dashboard>, sqlx::Error> {
        let rows = sqlx::query_as::<_, DashboardRow>(
            r#"SELECT d.id, d.name, d.description, d.widgets, d.layout, d.is_public, d.created_at
             FROM dashboards d
             INNER JOIN dashboard_shares_v11 ds ON d.id = ds.dashboard_id
             WHERE ds.user_id = $1
             ORDER BY ds.created_at DESC"#,
        )
        .bind(user_id)
    ...
    // V14: Report scheduling v12

    pub async fn create_report_schedule_v12(
        &self,
        input: CreateReportScheduleV12,
    ) -> Result<ReportScheduleV12, sqlx::Error> {
        let row = sqlx::query_as::<_, ReportScheduleV12Row>(
            r#"INSERT INTO report_schedules_v12 (report_id, cron_expression, enabled, next_run_at)
             VALUES ($1, $2, $3, $4)
             RETURNING id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at"#,
        )
        .bind(input.report_id)
    ...
    pub async fn get_report_schedule_v12(
        &self,
        id: uuid::Uuid,
    ) -> Result<Option<ReportScheduleV12>, sqlx::Error> {
        let row = sqlx::query_as::<_, ReportScheduleV12Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v12 WHERE id = $1"#,
        )
        .bind(id)
        .fetch_optional(&self.pool)
        .await?;
    ...
    pub async fn list_report_schedules_v12(
        &self,
    ) -> Result<Vec<ReportScheduleV12>, sqlx::Error> {
        let rows = sqlx::query_as::<_, ReportScheduleV12Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v12 ORDER BY created_at DESC"#,
        )
        .fetch_all(&self.pool)
        .await?;
        Ok(rows.into_iter().map(|r| r.into()).collect())
    ...
    pub async fn get_due_schedules_v12(
        &self,
    ) -> Result<Vec<ReportScheduleV12>, sqlx::Error> {
        let rows = sqlx::query_as::<_, ReportScheduleV12Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v12 WHERE enabled = true AND next_run_at <= NOW()
             ORDER BY next_run_at ASC"#,
        )
        .fetch_all(&self.pool)
        .await?;
    ...
    pub async fn mark_schedule_executed_v12(
        &self,
        id: uuid::Uuid,
    ) -> Result<(), sqlx::Error> {
        sqlx::query(
            r#"UPDATE report_schedules_v12 SET last_run_at = NOW() WHERE id = $1"#,
        )
        .bind(id)
        .execute(&self.pool)
        .await?;
    ...
    pub async fn update_report_schedule_v12(
        &self,
        id: uuid::Uuid,
        input: UpdateReportScheduleV12,
    ) -> Result<ReportScheduleV12, sqlx::Error> {
        let row = sqlx::query_as::<_, ReportScheduleV12Row>(
            r#"UPDATE report_schedules_v12 SET
             cron_expression = COALESCE($2, cron_expression),
             enabled = COALESCE($3, enabled),
             next_run_at = COALESCE($4, next_run_at)
             WHERE id = $1
    ...
    pub async fn delete_report_schedule_v12(
        &self,
        id: uuid::Uuid,
    ) -> Result<bool, sqlx::Error> {
        let result = sqlx::query("DELETE FROM report_schedules_v12 WHERE id = $1")
            .bind(id)
            .execute(&self.pool)
            .await?;
        Ok(result.rows_affected() > 0)
    ...
    // V14: Template management v6

    pub async fn create_dashboard_template_v6(
        &self,
        input: CreateDashboardTemplateV6,
    ) -> Result<DashboardTemplateV6, sqlx::Error> {
        let row = sqlx::query_as::<_, DashboardTemplateV6Row>(
            r#"INSERT INTO dashboard_templates_v6 (name, description, template_type, config, is_public, author_id)
             VALUES ($1, $2, $3, $4, $5, $6)
             RETURNING id, name, description, template_type, config, is_public, author_id, usage_count, created_at, updated_at"#,
        )
        .bind(&input.name)
        .bind(input.description.as_deref().unwrap_or(""))
        .bind(&input.template_type)
    ...
    pub async fn create_report_template_v6(
        &self,
        input: CreateReportTemplateV6,
    ) -> Result<ReportTemplateV6, sqlx::Error> {
        let row = sqlx::query_as::<_, ReportTemplateV6Row>(
            r#"INSERT INTO report_templates_v6 (name, description, report_type, config, is_public, author_id)
             VALUES ($1, $2, $3, $4, $5, $6)
             RETURNING id, name, description, report_type, config, is_public, author_id, usage_count, created_at, updated_at"#,
        )
        .bind(&input.name)
        .bind(input.description.as_deref().unwrap_or(""))
        .bind(&input.report_type)
    ...
    // V14: Dashboard stats v14

    pub async fn get_dashboard_stats_v14(
        &self,
    ) -> Result<DashboardStatsV14, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct StatsRow {
            total_dashboards: i64,
            public_dashboards: i64,
        ...
        let share_stats = sqlx::query_as::<_, ShareStatsRow>(
            r#"SELECT COUNT(*) as total_shares FROM dashboard_shares_v11"#,
        )
        .fetch_one(&self.pool)
        .await?;

        let schedule_stats = sqlx::query_as::<_, ScheduleStatsRow>(
            r#"SELECT COUNT(*) as total_schedules FROM report_schedules_v12"#,
        )
        .fetch_one(&self.pool)
        .await?;

        Ok(DashboardStatsV14 {
            total_dashboards: dash_stats.total_dashboards,
            public_dashboards: dash_stats.public_dashboards,
            total_reports: report_stats.total_reports,
            scheduled_reports: report_stats.scheduled_reports,
...
impl From<DashboardTemplateV6Row> for DashboardTemplateV6 {
    fn from(row: DashboardTemplateV6Row) -> Self {
        DashboardTemplateV6 {
            id: row.id,
            name: row.name,
            description: row.description,
...
impl From<ReportTemplateV6Row> for ReportTemplateV6 {
    fn from(row: ReportTemplateV6Row) -> Self {
        ReportTemplateV6 {
            id: row.id,
            name: row.name,
            description: row.description,
...
impl DashboardReportingService {
    // V15: Dashboard sharing v12 and report scheduling v13

    pub async fn share_dashboard_v12(
        &self,
        dashboard_id: uuid::Uuid,
        user_id: uuid::Uuid,
        permission: &str,
    ) -> Result<DashboardShareV12, sqlx::Error> {
        let row = sqlx::query_as::<_, DashboardShareV12Row>(
            r#"INSERT INTO dashboard_shares_v12 (dashboard_id, user_id, permission)
             VALUES ($1, $2, $3)
             ON CONFLICT (dashboard_id, user_id) DO UPDATE SET permission = $3
             RETURNING id, dashboard_id, user_id, permission, created_at"#,
        )
    ...
    pub async fn get_dashboard_share_v12(
        &self,
        id: uuid::Uuid,
    ) -> Result<Option<DashboardShareV12>, sqlx::Error> {
        let row = sqlx::query_as::<_, DashboardShareV12Row>(
            r#"SELECT id, dashboard_id, user_id, permission, created_at
             FROM dashboard_shares_v12 WHERE id = $1"#,
        )
        .bind(id)
        .fetch_optional(&self.pool)
        .await?;
    ...
    pub async fn list_dashboard_shares_v12(
        &self,
        dashboard_id: uuid::Uuid,
    ) -> Result<Vec<DashboardShareV12>, sqlx::Error> {
        let rows = sqlx::query_as::<_, DashboardShareV12Row>(
            r#"SELECT id, dashboard_id, user_id, permission, created_at
             FROM dashboard_shares_v12 WHERE dashboard_id = $1 ORDER BY created_at DESC"#,
        )
        .bind(dashboard_id)
        .fetch_all(&self.pool)
        .await?;
    ...
    pub async fn remove_dashboard_share_v12(
        &self,
        id: uuid::Uuid,
    ) -> Result<bool, sqlx::Error> {
        let result = sqlx::query("DELETE FROM dashboard_shares_v12 WHERE id = $1")
            .bind(id)
            .execute(&self.pool)
            .await?;
        Ok(result.rows_affected() > 0)
    ...
    pub async fn create_report_schedule_v13(
        &self,
        input: CreateReportScheduleV13,
    ) -> Result<ReportScheduleV13, sqlx::Error> {
        let row = sqlx::query_as::<_, ReportScheduleV13Row>(
            r#"INSERT INTO report_schedules_v13 (report_id, cron_expression, enabled, next_run_at)
             VALUES ($1, $2, $3, $4)
             RETURNING id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at"#,
        )
        .bind(input.report_id)
    ...
    pub async fn get_report_schedule_v13(
        &self,
        id: uuid::Uuid,
    ) -> Result<Option<ReportScheduleV13>, sqlx::Error> {
        let row = sqlx::query_as::<_, ReportScheduleV13Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v13 WHERE id = $1"#,
        )
        .bind(id)
        .fetch_optional(&self.pool)
        .await?;
    ...
    pub async fn list_report_schedules_v13(
        &self,
    ) -> Result<Vec<ReportScheduleV13>, sqlx::Error> {
        let rows = sqlx::query_as::<_, ReportScheduleV13Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v13 ORDER BY next_run_at ASC"#,
        )
        .fetch_all(&self.pool)
        .await?;
        Ok(rows.into_iter().map(|r| r.into()).collect())
    ...
    pub async fn update_report_schedule_v13(
        &self,
        id: uuid::Uuid,
        input: UpdateReportScheduleV13,
    ) -> Result<ReportScheduleV13, sqlx::Error> {
        let row = sqlx::query_as::<_, ReportScheduleV13Row>(
            r#"UPDATE report_schedules_v13 SET
             cron_expression = COALESCE($2, cron_expression),
             enabled = COALESCE($3, enabled),
             next_run_at = COALESCE($4, next_run_at)
             WHERE id = $1
    ...
    pub async fn delete_report_schedule_v13(
        &self,
        id: uuid::Uuid,
    ) -> Result<bool, sqlx::Error> {
        let result = sqlx::query("DELETE FROM report_schedules_v13 WHERE id = $1")
            .bind(id)
            .execute(&self.pool)
            .await?;
        Ok(result.rows_affected() > 0)
    ...
    pub async fn get_due_schedules_v13(
        &self,
    ) -> Result<Vec<ReportScheduleV13>, sqlx::Error> {
        let rows = sqlx::query_as::<_, ReportScheduleV13Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v13 WHERE enabled = true AND next_run_at <= NOW()
             ORDER BY next_run_at ASC"#,
        )
        .fetch_all(&self.pool)
        .await?;
    ...
    // V16: Dashboard sharing v13

    pub async fn share_dashboard_v13(
        &self,
        dashboard_id: uuid::Uuid,
        user_id: uuid::Uuid,
        permission: &str,
    ) -> Result<DashboardShareV13, sqlx::Error> {
        let row = sqlx::query_as::<_, DashboardShareV13Row>(
            r#"INSERT INTO dashboard_shares_v13 (dashboard_id, user_id, permission)
             VALUES ($1, $2, $3)
             ON CONFLICT (dashboard_id, user_id) DO UPDATE SET permission = $3
             RETURNING id, dashboard_id, user_id, permission, created_at"#,
        )
    ...
    pub async fn get_dashboard_shares_v13(
        &self,
        dashboard_id: uuid::Uuid,
    ) -> Result<Vec<DashboardShareV13>, sqlx::Error> {
        let rows = sqlx::query_as::<_, DashboardShareV13Row>(
            r#"SELECT id, dashboard_id, user_id, permission, created_at
             FROM dashboard_shares_v13 WHERE dashboard_id = $1
             ORDER BY created_at DESC"#,
        )
        .bind(dashboard_id)
        .fetch_all(&self.pool)
    ...
    pub async fn remove_dashboard_share_v13(
        &self,
        dashboard_id: uuid::Uuid,
        user_id: uuid::Uuid,
    ) -> Result<bool, sqlx::Error> {
        let result = sqlx::query(
            "DELETE FROM dashboard_shares_v13 WHERE dashboard_id = $1 AND user_id = $2",
        )
        .bind(dashboard_id)
        .bind(user_id)
        .execute(&self.pool)
    ...
    pub async fn get_dashboards_shared_with_user_v13(
        &self,
        user_id: uuid::Uuid,
    ) -> Result<Vec<Dashboard>, sqlx::Error> {
        let rows = sqlx::query_as::<_, DashboardRow>(
            r#"SELECT d.id, d.name, d.description, d.widgets, d.layout, d.is_public, d.created_at
             FROM dashboards d
             INNER JOIN dashboard_shares_v13 ds ON d.id = ds.dashboard_id
             WHERE ds.user_id = $1
             ORDER BY ds.created_at DESC"#,
        )
        .bind(user_id)
    ...
    // V16: Report scheduling v14

    pub async fn create_report_schedule_v14(
        &self,
        input: CreateReportScheduleV14,
    ) -> Result<ReportScheduleV14, sqlx::Error> {
        let row = sqlx::query_as::<_, ReportScheduleV14Row>(
            r#"INSERT INTO report_schedules_v14 (report_id, cron_expression, enabled, next_run_at)
             VALUES ($1, $2, $3, $4)
             RETURNING id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at"#,
        )
        .bind(input.report_id)
    ...
    pub async fn get_report_schedule_v14(
        &self,
        id: uuid::Uuid,
    ) -> Result<Option<ReportScheduleV14>, sqlx::Error> {
        let row = sqlx::query_as::<_, ReportScheduleV14Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v14 WHERE id = $1"#,
        )
        .bind(id)
        .fetch_optional(&self.pool)
        .await?;
    ...
    pub async fn list_report_schedules_v14(
        &self,
    ) -> Result<Vec<ReportScheduleV14>, sqlx::Error> {
        let rows = sqlx::query_as::<_, ReportScheduleV14Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v14 ORDER BY created_at DESC"#,
        )
        .fetch_all(&self.pool)
        .await?;
        Ok(rows.into_iter().map(|r| r.into()).collect())
    ...
    pub async fn get_due_schedules_v14(
        &self,
    ) -> Result<Vec<ReportScheduleV14>, sqlx::Error> {
        let rows = sqlx::query_as::<_, ReportScheduleV14Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v14 WHERE enabled = true AND next_run_at <= NOW()
             ORDER BY next_run_at ASC"#,
        )
        .fetch_all(&self.pool)
        .await?;
    ...
    pub async fn mark_schedule_executed_v14(
        &self,
        id: uuid::Uuid,
    ) -> Result<(), sqlx::Error> {
        sqlx::query(
            r#"UPDATE report_schedules_v14 SET last_run_at = NOW() WHERE id = $1"#,
        )
        .bind(id)
        .execute(&self.pool)
        .await?;
    ...
    pub async fn update_report_schedule_v14(
        &self,
        id: uuid::Uuid,
        input: UpdateReportScheduleV14,
    ) -> Result<ReportScheduleV14, sqlx::Error> {
        let row = sqlx::query_as::<_, ReportScheduleV14Row>(
            r#"UPDATE report_schedules_v14 SET
             cron_expression = COALESCE($2, cron_expression),
             enabled = COALESCE($3, enabled),
             next_run_at = COALESCE($4, next_run_at)
             WHERE id = $1
    ...
    pub async fn delete_report_schedule_v14(
        &self,
        id: uuid::Uuid,
    ) -> Result<bool, sqlx::Error> {
        let result = sqlx::query("DELETE FROM report_schedules_v14 WHERE id = $1")
            .bind(id)
            .execute(&self.pool)
            .await?;
        Ok(result.rows_affected() > 0)
    ...
    // V16: Dashboard stats v16

    pub async fn get_dashboard_stats_v16(
        &self,
    ) -> Result<DashboardStatsV16, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct StatsRow {
            total_dashboards: i64,
            public_dashboards: i64,
        ...
        let share_stats = sqlx::query_as::<_, ShareStatsRow>(
            r#"SELECT COUNT(*) as total_shares FROM dashboard_shares_v13"#,
        )
        .fetch_one(&self.pool)
        .await?;

        let schedule_stats = sqlx::query_as::<_, ScheduleStatsRow>(
            r#"SELECT COUNT(*) as total_schedules FROM report_schedules_v14"#,
        )
        .fetch_one(&self.pool)
        .await?;
        ...
        let avg_shares = sqlx::query_as::<_, AvgShareRow>(
            r#"SELECT COALESCE(COUNT(ds.id)::float / NULLIF(COUNT(DISTINCT d.id), 0), 0.0) as avg_shares
             FROM dashboards d LEFT JOIN dashboard_shares_v13 ds ON d.id = ds.dashboard_id"#,
        )
        .fetch_one(&self.pool)
        .await?;

        Ok(DashboardStatsV16 {
            total_dashboards: dash_stats.total_dashboards,
            public_dashboards: dash_stats.public_dashboards,
            total_reports: report_stats.total_reports,
            scheduled_reports: report_stats.scheduled_reports,
    ...
    // V17: Dashboard sharing v14

    pub async fn create_dashboard_share_v14(
        &self,
        input: CreateDashboardShareV14,
    ) -> Result<DashboardShareV14, sqlx::Error> {
        let row = sqlx::query_as::<_, DashboardShareV14Row>(
            r#"INSERT INTO dashboard_shares_v14 (dashboard_id, user_id, permission)
             VALUES ($1, $2, $3)
             ON CONFLICT (dashboard_id, user_id) DO UPDATE SET permission = $3
             RETURNING id, dashboard_id, user_id, permission, created_at"#,
        )
    ...
    pub async fn get_dashboard_share_v14(
        &self,
        id: uuid::Uuid,
    ) -> Result<Option<DashboardShareV14>, sqlx::Error> {
        let row = sqlx::query_as::<_, DashboardShareV14Row>(
            r#"SELECT id, dashboard_id, user_id, permission, created_at
             FROM dashboard_shares_v14 WHERE id = $1"#,
        )
        .bind(id)
        .fetch_optional(&self.pool)
        .await?;
    ...
    pub async fn list_dashboard_shares_v14(
        &self,
        dashboard_id: uuid::Uuid,
    ) -> Result<DashboardShareListV14, sqlx::Error> {
        let rows = sqlx::query_as::<_, DashboardShareV14Row>(
            r#"SELECT id, dashboard_id, user_id, permission, created_at
             FROM dashboard_shares_v14 WHERE dashboard_id = $1
             ORDER BY created_at DESC"#,
        )
        .bind(dashboard_id)
        .fetch_all(&self.pool)
        ...
        Ok(DashboardShareListV14 {
            shares: rows.into_iter().map(|r| r.into()).collect(),
            total_count,
        })
    }

    pub async fn delete_dashboard_share_v14(
        &self,
        id: uuid::Uuid,
    ) -> Result<bool, sqlx::Error> {
        let result = sqlx::query("DELETE FROM dashboard_shares_v14 WHERE id = $1")
            .bind(id)
            .execute(&self.pool)
            .await?;
        Ok(result.rows_affected() > 0)
    ...
    // V17: Report scheduling v15

    pub async fn create_report_schedule_v15(
        &self,
        input: CreateReportScheduleV15,
    ) -> Result<ReportScheduleV15, sqlx::Error> {
        let row = sqlx::query_as::<_, ReportScheduleV15Row>(
            r#"INSERT INTO report_schedules_v15 (report_id, cron_expression, enabled, next_run_at)
             VALUES ($1, $2, $3, $4)
             RETURNING id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at"#,
        )
        .bind(input.report_id)
    ...
    pub async fn get_report_schedule_v15(
        &self,
        id: uuid::Uuid,
    ) -> Result<Option<ReportScheduleV15>, sqlx::Error> {
        let row = sqlx::query_as::<_, ReportScheduleV15Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v15 WHERE id = $1"#,
        )
        .bind(id)
        .fetch_optional(&self.pool)
        .await?;
    ...
    pub async fn list_report_schedules_v15(
        &self,
        report_id: uuid::Uuid,
    ) -> Result<ReportScheduleListV15, sqlx::Error> {
        let rows = sqlx::query_as::<_, ReportScheduleV15Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v15 WHERE report_id = $1
             ORDER BY created_at DESC"#,
        )
        .bind(report_id)
        .fetch_all(&self.pool)
        .await?;
        let total_count = rows.len() as i64;
        Ok(ReportScheduleListV15 {
            schedules: rows.into_iter().map(|r| r.into()).collect(),
            total_count,
        })
    }

    pub async fn update_report_schedule_v15(
        &self,
        id: uuid::Uuid,
        input: UpdateReportScheduleV15,
    ) -> Result<ReportScheduleV15, sqlx::Error> {
        let row = sqlx::query_as::<_, ReportScheduleV15Row>(
            r#"UPDATE report_schedules_v15 SET
             cron_expression = COALESCE($2, cron_expression),
             enabled = COALESCE($3, enabled),
             next_run_at = COALESCE($4, next_run_at)
             WHERE id = $1
    ...
    pub async fn delete_report_schedule_v15(
        &self,
        id: uuid::Uuid,
    ) -> Result<bool, sqlx::Error> {
        let result = sqlx::query("DELETE FROM report_schedules_v15 WHERE id = $1")
            .bind(id)
            .execute(&self.pool)
            .await?;
        Ok(result.rows_affected() > 0)
    ...
    // V17: Dashboard stats v17

    pub async fn get_dashboard_stats_v17(
        &self,
    ) -> Result<DashboardStatsV17, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct StatsRow {
            total_dashboards: i64,
            public_dashboards: i64,
        ...
        let share_stats = sqlx::query_as::<_, ShareStatsRow>(
            r#"SELECT COUNT(*) as total_shares FROM dashboard_shares_v14"#,
        )
        .fetch_one(&self.pool)
        .await?;

        let schedule_stats = sqlx::query_as::<_, ScheduleStatsRow>(
            r#"SELECT COUNT(*) as total_schedules FROM report_schedules_v15"#,
        )
        .fetch_one(&self.pool)
        .await?;
        ...
        let avg_shares = sqlx::query_as::<_, AvgShareRow>(
            r#"SELECT COALESCE(COUNT(ds.id)::float / NULLIF(COUNT(DISTINCT d.id), 0), 0.0) as avg_shares
             FROM dashboards d LEFT JOIN dashboard_shares_v14 ds ON d.id = ds.dashboard_id"#,
        )
        .fetch_one(&self.pool)
        .await?;

        Ok(DashboardStatsV17 {
            total_dashboards: dash_stats.total_dashboards,
            public_dashboards: dash_stats.public_dashboards,
            total_reports: report_stats.total_reports,
            scheduled_reports: report_stats.scheduled_reports,
...
impl From<DashboardShareV14Row> for DashboardShareV14 {
    fn from(row: DashboardShareV14Row) -> Self {
        DashboardShareV14 {
            id: row.id,
            dashboard_id: row.dashboard_id,
            user_id: row.user_id,
...
impl From<ReportScheduleV15Row> for ReportScheduleV15 {
    fn from(row: ReportScheduleV15Row) -> Self {
        ReportScheduleV15 {
            id: row.id,
            report_id: row.report_id,
            cron_expression: row.cron_expression,
...
impl From<DashboardShareV15Row> for DashboardShareV15 {
    fn from(row: DashboardShareV15Row) -> Self {
        DashboardShareV15 {
            id: row.id,
            dashboard_id: row.dashboard_id,
            user_id: row.user_id,
...
impl From<ReportScheduleV16Row> for ReportScheduleV16 {
    fn from(row: ReportScheduleV16Row) -> Self {
        ReportScheduleV16 {
            id: row.id,
            report_id: row.report_id,
            cron_expression: row.cron_expression,
...
impl DashboardReportingService {
    pub async fn create_dashboard_share_v15(
        &self,
        input: CreateDashboardShareV15,
    ) -> Result<DashboardShareV15, sqlx::Error> {
        let row = sqlx::query_as::<_, DashboardShareV15Row>(
            r#"INSERT INTO dashboard_shares_v15 (dashboard_id, user_id, permission)
             VALUES ($1, $2, $3)
             RETURNING id, dashboard_id, user_id, permission, created_at"#,
        )
        .bind(input.dashboard_id)
    ...
    pub async fn get_dashboard_shares_v15(
        &self,
        dashboard_id: uuid::Uuid,
    ) -> Result<DashboardShareListV15, sqlx::Error> {
        let rows = sqlx::query_as::<_, DashboardShareV15Row>(
            r#"SELECT id, dashboard_id, user_id, permission, created_at
             FROM dashboard_shares_v15
        ...
        let total_count = rows.len() as i64;
        Ok(DashboardShareListV15 {
            shares: rows.into_iter().map(|r| r.into()).collect(),
            total_count,
        })
    }

    pub async fn delete_dashboard_share_v15(
        &self,
        id: uuid::Uuid,
    ) -> Result<bool, sqlx::Error> {
        let result = sqlx::query("DELETE FROM dashboard_shares_v15 WHERE id = $1")
            .bind(id)
            .execute(&self.pool)
            .await?;
        Ok(result.rows_affected() > 0)
    ...
    pub async fn create_report_schedule_v16(
        &self,
        input: CreateReportScheduleV16,
    ) -> Result<ReportScheduleV16, sqlx::Error> {
        let row = sqlx::query_as::<_, ReportScheduleV16Row>(
            r#"INSERT INTO report_schedules_v16 (report_id, cron_expression, enabled, next_run_at)
             VALUES ($1, $2, $3, $4)
             RETURNING id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at"#,
        )
        .bind(input.report_id)
    ...
    pub async fn get_report_schedule_v16(
        &self,
        id: uuid::Uuid,
    ) -> Result<Option<ReportScheduleV16>, sqlx::Error> {
        let row = sqlx::query_as::<_, ReportScheduleV16Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v16
             WHERE id = $1"#,
        )
        .bind(id)
        .fetch_optional(&self.pool)
    ...
    pub async fn list_report_schedules_v16(
        &self,
        enabled_only: Option<bool>,
    ) -> Result<ReportScheduleListV16, sqlx::Error> {
        let rows = sqlx::query_as::<_, ReportScheduleV16Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v16
        ...
        let total_count = rows.len() as i64;
        Ok(ReportScheduleListV16 {
            schedules: rows.into_iter().map(|r| r.into()).collect(),
            total_count,
        })
    }

    pub async fn update_report_schedule_v16(
        &self,
        id: uuid::Uuid,
        input: UpdateReportScheduleV16,
    ) -> Result<ReportScheduleV16, sqlx::Error> {
        let row = sqlx::query_as::<_, ReportScheduleV16Row>(
            r#"UPDATE report_schedules_v16 SET
             cron_expression = COALESCE($2, cron_expression),
             enabled = COALESCE($3, enabled),
             next_run_at = COALESCE($4, next_run_at)
             WHERE id = $1
    ...
    pub async fn delete_report_schedule_v16(
        &self,
        id: uuid::Uuid,
    ) -> Result<bool, sqlx::Error> {
        let result = sqlx::query("DELETE FROM report_schedules_v16 WHERE id = $1")
            .bind(id)
            .execute(&self.pool)
            .await?;
        Ok(result.rows_affected() > 0)
    ...
    pub async fn get_dashboard_stats_v18(
        &self,
    ) -> Result<DashboardStatsV18, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct DashStats {
            total_dashboards: i64,
            public_dashboards: i64,
        ...
        let dash_stats = sqlx::query_as::<_, DashStats>(
            r#"SELECT COUNT(*) as total_dashboards,
             COUNT(*) FILTER (WHERE is_public) as public_dashboards
             FROM dashboards"#,
        )
        ...
        let report_stats = sqlx::query_as::<_, ReportStats>(
            r#"SELECT COUNT(*) as total_reports,
             COUNT(*) FILTER (WHERE schedule IS NOT NULL) as scheduled_reports
             FROM reports"#,
        )
        ...
        let share_stats = sqlx::query_as::<_, ShareStats>(
            r#"SELECT COUNT(*) as total_shares FROM dashboard_shares_v15"#,
        )
        .fetch_one(&self.pool)
        .await?;

        let schedule_stats = sqlx::query_as::<_, ScheduleStats>(
            r#"SELECT COUNT(*) as total_schedules FROM report_schedules_v16"#,
        )
        .fetch_one(&self.pool)
        .await?;

        let avg_shares = sqlx::query_as::<_, AvgShares>(
            r#"SELECT COALESCE(AVG(share_count), 0.0) as avg_shares
             FROM (SELECT COUNT(*) as share_count FROM dashboard_shares_v15 GROUP BY dashboard_id) sub"#,
        )
        .fetch_one(&self.pool)
        .await?;

        Ok(DashboardStatsV18 {
            total_dashboards: dash_stats.total_dashboards,
            public_dashboards: dash_stats.public_dashboards,
            total_reports: report_stats.total_reports,
            scheduled_reports: report_stats.scheduled_reports,
    ...
    pub async fn create_dashboard_share_v16(
        &self,
        input: CreateDashboardShareV16,
    ) -> Result<DashboardShareV16, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct DashboardShareV16Row {
            id: uuid::Uuid,
            dashboard_id: uuid::Uuid,
            user_id: uuid::Uuid,
            permission: String,
        ...
        impl From<DashboardShareV16Row> for DashboardShareV16 {
            fn from(row: DashboardShareV16Row) -> Self {
                DashboardShareV16 {
                    id: row.id,
                    dashboard_id: row.dashboard_id,
                    user_id: row.user_id,
        ...
        let row = sqlx::query_as::<_, DashboardShareV16Row>(
            r#"INSERT INTO dashboard_shares_v16 (dashboard_id, user_id, permission)
             VALUES ($1, $2, $3)
             ON CONFLICT (dashboard_id, user_id) DO UPDATE SET permission = $3
             RETURNING id, dashboard_id, user_id, permission, created_at"#,
        )
    ...
    pub async fn get_dashboard_shares_v16(
        &self,
        dashboard_id: uuid::Uuid,
    ) -> Result<Vec<DashboardShareV16>, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct DashboardShareV16Row {
            id: uuid::Uuid,
            dashboard_id: uuid::Uuid,
        ...
        let rows = sqlx::query_as::<_, DashboardShareV16Row>(
            r#"SELECT id, dashboard_id, user_id, permission, created_at
             FROM dashboard_shares_v16 WHERE dashboard_id = $1
             ORDER BY created_at DESC"#,
        )
        .bind(dashboard_id)
        .fetch_all(&self.pool)
    ...
    pub async fn delete_dashboard_share_v16(
        &self,
        id: uuid::Uuid,
    ) -> Result<bool, sqlx::Error> {
        let result = sqlx::query("DELETE FROM dashboard_shares_v16 WHERE id = $1")
            .bind(id)
            .execute(&self.pool)
            .await?;
        Ok(result.rows_affected() > 0)
    ...
    // V19: Report scheduling v17

    pub async fn create_report_schedule_v17(
        &self,
        input: CreateReportScheduleV17,
    ) -> Result<ReportScheduleV17, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct ReportScheduleV17Row {
            id: uuid::Uuid,
            report_id: uuid::Uuid,
            cron_expression: String,
            enabled: bool,
        ...
        impl From<ReportScheduleV17Row> for ReportScheduleV17 {
            fn from(row: ReportScheduleV17Row) -> Self {
                ReportScheduleV17 {
                    id: row.id,
                    report_id: row.report_id,
                    cron_expression: row.cron_expression,
        ...
        let row = sqlx::query_as::<_, ReportScheduleV17Row>(
            r#"INSERT INTO report_schedules_v17 (report_id, cron_expression, enabled, next_run_at)
             VALUES ($1, $2, $3, $4)
             RETURNING id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at"#,
        )
        .bind(input.report_id)
    ...
    pub async fn get_report_schedule_v17(
        &self,
        id: uuid::Uuid,
    ) -> Result<Option<ReportScheduleV17>, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct ReportScheduleV17Row {
            id: uuid::Uuid,
            report_id: uuid::Uuid,
        ...
        let row = sqlx::query_as::<_, ReportScheduleV17Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v17 WHERE id = $1"#,
        )
        .bind(id)
        .fetch_optional(&self.pool)
        .await?;
    ...
    pub async fn list_report_schedules_v17(
        &self,
    ) -> Result<Vec<ReportScheduleV17>, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct ReportScheduleV17Row {
            id: uuid::Uuid,
            report_id: uuid::Uuid,
        ...
        let rows = sqlx::query_as::<_, ReportScheduleV17Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v17 ORDER BY created_at DESC"#,
        )
        .fetch_all(&self.pool)
        .await?;
        Ok(rows.into_iter().map(|r| r.into()).collect())
    ...
    pub async fn update_report_schedule_v17(
        &self,
        id: uuid::Uuid,
        input: UpdateReportScheduleV17,
    ) -> Result<ReportScheduleV17, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct ReportScheduleV17Row {
            id: uuid::Uuid,
        ...
        let row = sqlx::query_as::<_, ReportScheduleV17Row>(
            r#"UPDATE report_schedules_v17 SET
             cron_expression = COALESCE($2, cron_expression),
             enabled = COALESCE($3, enabled),
             next_run_at = COALESCE($4, next_run_at)
             WHERE id = $1
    ...
    pub async fn delete_report_schedule_v17(
        &self,
        id: uuid::Uuid,
    ) -> Result<bool, sqlx::Error> {
        let result = sqlx::query("DELETE FROM report_schedules_v17 WHERE id = $1")
            .bind(id)
            .execute(&self.pool)
            .await?;
        Ok(result.rows_affected() > 0)
    ...
    pub async fn get_due_schedules_v17(
        &self,
    ) -> Result<Vec<ReportScheduleV17>, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct ReportScheduleV17Row {
        ...
        let rows = sqlx::query_as::<_, ReportScheduleV17Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v17 WHERE enabled = true AND next_run_at <= NOW()
             ORDER BY next_run_at ASC"#,
        )
        .fetch_all(&self.pool)
        .await?;
    ...
    pub async fn mark_schedule_executed_v17(
        &self,
        id: uuid::Uuid,
    ) -> Result<(), sqlx::Error> {
        sqlx::query(
            r#"UPDATE report_schedules_v17 SET last_run_at = NOW() WHERE id = $1"#,
        )
        .bind(id)
        .execute(&self.pool)
        .await?;
    ...
    // V20: Dashboard sharing v17

    pub async fn create_share_v17(
        &self,
        input: CreateDashboardShareV17,
    ) -> Result<DashboardShareV17, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct DashboardShareV17Row {
            id: uuid::Uuid,
            dashboard_id: uuid::Uuid,
            user_id: uuid::Uuid,
            permission: String,
        ...
        impl From<DashboardShareV17Row> for DashboardShareV17 {
            fn from(row: DashboardShareV17Row) -> Self {
                DashboardShareV17 {
                    id: row.id,
                    dashboard_id: row.dashboard_id,
                    user_id: row.user_id,
        ...
        let row = sqlx::query_as::<_, DashboardShareV17Row>(
            r#"INSERT INTO dashboard_shares_v17 (dashboard_id, user_id, permission)
             VALUES ($1, $2, $3)
             ON CONFLICT (dashboard_id, user_id) DO UPDATE SET permission = EXCLUDED.permission
             RETURNING id, dashboard_id, user_id, permission, created_at"#,
        )
        .bind(input.dashboard_id)
        .bind(input.user_id)
    ...
    pub async fn list_shares_v17(
        &self,
        dashboard_id: uuid::Uuid,
    ) -> Result<DashboardShareListV17, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct DashboardShareV17Row {
            id: uuid::Uuid,
            dashboard_id: uuid::Uuid,
        ...
        let total_count = sqlx::query_scalar::<_, i64>(
            r#"SELECT COUNT(*) FROM dashboard_shares_v17 WHERE dashboard_id = $1"#,
        )
        .bind(dashboard_id)
        .fetch_one(&self.pool)
        .await?;

        let rows = sqlx::query_as::<_, DashboardShareV17Row>(
            r#"SELECT id, dashboard_id, user_id, permission, created_at
             FROM dashboard_shares_v17 WHERE dashboard_id = $1
             ORDER BY created_at DESC"#,
        )
        .bind(dashboard_id)
        .fetch_all(&self.pool)
        ...
        Ok(DashboardShareListV17 {
            shares: rows.into_iter().map(|r| r.into()).collect(),
            total_count,
        })
    }

    pub async fn delete_share_v17(
        &self,
        id: uuid::Uuid,
    ) -> Result<bool, sqlx::Error> {
        let result = sqlx::query("DELETE FROM dashboard_shares_v17 WHERE id = $1")
            .bind(id)
            .execute(&self.pool)
            .await?;
        Ok(result.rows_affected() > 0)
    ...
    // V20: Report scheduling v18

    pub async fn create_schedule_v18(
        &self,
        input: CreateReportScheduleV18,
    ) -> Result<ReportScheduleV18, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct ReportScheduleV18Row {
            id: uuid::Uuid,
            report_id: uuid::Uuid,
            cron_expression: String,
            enabled: bool,
        ...
        impl From<ReportScheduleV18Row> for ReportScheduleV18 {
            fn from(row: ReportScheduleV18Row) -> Self {
                ReportScheduleV18 {
                    id: row.id,
                    report_id: row.report_id,
                    cron_expression: row.cron_expression,
        ...
        let row = sqlx::query_as::<_, ReportScheduleV18Row>(
            r#"INSERT INTO report_schedules_v18 (report_id, cron_expression, enabled, next_run_at)
             VALUES ($1, $2, $3, $4)
             RETURNING id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at"#,
        )
        .bind(input.report_id)
    ...
    pub async fn get_schedule_v18(
        &self,
        id: uuid::Uuid,
    ) -> Result<Option<ReportScheduleV18>, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct ReportScheduleV18Row {
            id: uuid::Uuid,
            report_id: uuid::Uuid,
        ...
        let row = sqlx::query_as::<_, ReportScheduleV18Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v18 WHERE id = $1"#,
        )
        .bind(id)
        .fetch_optional(&self.pool)
        .await?;
    ...
    pub async fn update_schedule_v18(
        &self,
        id: uuid::Uuid,
        input: UpdateReportScheduleV18,
    ) -> Result<ReportScheduleV18, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct ReportScheduleV18Row {
            id: uuid::Uuid,
        ...
        let row = sqlx::query_as::<_, ReportScheduleV18Row>(
            r#"UPDATE report_schedules_v18 SET
             cron_expression = COALESCE($2, cron_expression),
             enabled = COALESCE($3, enabled),
             next_run_at = COALESCE($4, next_run_at)
             WHERE id = $1
    ...
    pub async fn delete_schedule_v18(
        &self,
        id: uuid::Uuid,
    ) -> Result<bool, sqlx::Error> {
        let result = sqlx::query("DELETE FROM report_schedules_v18 WHERE id = $1")
            .bind(id)
            .execute(&self.pool)
            .await?;
        Ok(result.rows_affected() > 0)
    ...
    pub async fn get_due_schedules_v18(
        &self,
    ) -> Result<Vec<ReportScheduleV18>, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct ReportScheduleV18Row {
            id: uuid::Uuid,
            report_id: uuid::Uuid,
        ...
        let rows = sqlx::query_as::<_, ReportScheduleV18Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v18 WHERE enabled = true AND next_run_at <= NOW()
             ORDER BY next_run_at ASC"#,
        )
        .fetch_all(&self.pool)
        .await?;
    ...
    pub async fn mark_schedule_executed_v18(
        &self,
        id: uuid::Uuid,
    ) -> Result<(), sqlx::Error> {
        sqlx::query(
            r#"UPDATE report_schedules_v18 SET last_run_at = NOW() WHERE id = $1"#,
        )
        .bind(id)
        .execute(&self.pool)
        .await?;
    ...
    // V21: Dashboard sharing v18

    pub async fn create_share_v18(
        &self,
        input: CreateDashboardShareV18,
    ) -> Result<DashboardShareV18, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct DashboardShareV18Row {
            id: uuid::Uuid,
            dashboard_id: uuid::Uuid,
            user_id: uuid::Uuid,
            permission: String,
        ...
        impl From<DashboardShareV18Row> for DashboardShareV18 {
            fn from(row: DashboardShareV18Row) -> Self {
                DashboardShareV18 {
                    id: row.id,
                    dashboard_id: row.dashboard_id,
                    user_id: row.user_id,
        ...
        let row = sqlx::query_as::<_, DashboardShareV18Row>(
            r#"INSERT INTO dashboard_shares_v18 (dashboard_id, user_id, permission)
             VALUES ($1, $2, $3)
             ON CONFLICT (dashboard_id, user_id) DO UPDATE SET permission = EXCLUDED.permission
             RETURNING id, dashboard_id, user_id, permission, created_at"#,
        )
    ...
    pub async fn list_shares_v18(
        &self,
        dashboard_id: uuid::Uuid,
    ) -> Result<DashboardShareListV18, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct DashboardShareV18Row {
            id: uuid::Uuid,
            dashboard_id: uuid::Uuid,
        ...
        let total_count = sqlx::query_scalar::<_, i64>(
            r#"SELECT COUNT(*) FROM dashboard_shares_v18 WHERE dashboard_id = $1"#,
        )
        .bind(dashboard_id)
        .fetch_one(&self.pool)
        .await?;

        let rows = sqlx::query_as::<_, DashboardShareV18Row>(
            r#"SELECT id, dashboard_id, user_id, permission, created_at
             FROM dashboard_shares_v18 WHERE dashboard_id = $1
             ORDER BY created_at DESC"#,
        )
        .bind(dashboard_id)
        .fetch_all(&self.pool)
        ...
        Ok(DashboardShareListV18 {
            shares: rows.into_iter().map(|r| r.into()).collect(),
            total_count,
        })
    }

    pub async fn delete_share_v18(
        &self,
        id: uuid::Uuid,
    ) -> Result<bool, sqlx::Error> {
        let result = sqlx::query("DELETE FROM dashboard_shares_v18 WHERE id = $1")
            .bind(id)
            .execute(&self.pool)
            .await?;
        Ok(result.rows_affected() > 0)
    ...
    // V21: Report scheduling v19

    pub async fn create_schedule_v19(
        &self,
        input: CreateReportScheduleV19,
    ) -> Result<ReportScheduleV19, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct ReportScheduleV19Row {
            id: uuid::Uuid,
            report_id: uuid::Uuid,
            cron_expression: String,
            enabled: bool,
        ...
        impl From<ReportScheduleV19Row> for ReportScheduleV19 {
            fn from(row: ReportScheduleV19Row) -> Self {
                ReportScheduleV19 {
                    id: row.id,
                    report_id: row.report_id,
                    cron_expression: row.cron_expression,
        ...
        let row = sqlx::query_as::<_, ReportScheduleV19Row>(
            r#"INSERT INTO report_schedules_v19 (report_id, cron_expression, enabled, next_run_at)
             VALUES ($1, $2, $3, $4)
             RETURNING id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at"#,
        )
        .bind(input.report_id)
    ...
    pub async fn get_schedule_v19(
        &self,
        id: uuid::Uuid,
    ) -> Result<Option<ReportScheduleV19>, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct ReportScheduleV19Row {
            id: uuid::Uuid,
            report_id: uuid::Uuid,
        ...
        let row = sqlx::query_as::<_, ReportScheduleV19Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v19 WHERE id = $1"#,
        )
        .bind(id)
        .fetch_optional(&self.pool)
        .await?;
    ...
    pub async fn update_schedule_v19(
        &self,
        id: uuid::Uuid,
        input: UpdateReportScheduleV19,
    ) -> Result<ReportScheduleV19, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct ReportScheduleV19Row {
            id: uuid::Uuid,
        ...
        let row = sqlx::query_as::<_, ReportScheduleV19Row>(
            r#"UPDATE report_schedules_v19 SET
             cron_expression = COALESCE($2, cron_expression),
             enabled = COALESCE($3, enabled),
             next_run_at = COALESCE($4, next_run_at)
             WHERE id = $1
    ...
    pub async fn get_due_schedules_v19(
        &self,
    ) -> Result<Vec<ReportScheduleV19>, sqlx::Error> {
        #[derive(Debug, sqlx::FromRow)]
        struct ReportScheduleV19Row {
            id: uuid::Uuid,
            report_id: uuid::Uuid,
        ...
        let rows = sqlx::query_as::<_, ReportScheduleV19Row>(
            r#"SELECT id, report_id, cron_expression, enabled, last_run_at, next_run_at, created_at
             FROM report_schedules_v19 WHERE enabled = true AND next_run_at <= NOW()
             ORDER BY next_run_at ASC"#,
        )
        .fetch_all(&self.pool)
        .await?;
