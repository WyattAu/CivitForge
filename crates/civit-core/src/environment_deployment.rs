//! Environment Deployment: Advanced deployment tracking with metadata,
//! rollback tracking, deployment comparison, and deployment analytics.
...
pub struct EnvironmentDeploymentHistory {
    pub id: Uuid,
...
impl From<DeploymentRow> for EnvironmentDeploymentHistory {
...
impl From<ComparisonRow> for DeploymentComparison {
...
impl From<AnalyticsRow> for DeploymentAnalytics {
...
pub struct EnvironmentDeploymentService {
    pool: PgPool,
}

impl EnvironmentDeploymentService {
    ...
    ) -> Result<EnvironmentDeploymentHistory, sqlx::Error> {
    ...
    pub async fn get_deployment(
        &self,
        deployment_id: Uuid,
    ) -> Result<Option<EnvironmentDeploymentHistory>, sqlx::Error> {
        let row = sqlx::query_as::<_, DeploymentRow>(
    ...
    pub async fn list_deployments_for_environment(
        ...
        limit: i64,
        offset: i64,
    ) -> Result<Vec<EnvironmentDeploymentHistory>, sqlx::Error> {
    ...
    ) -> Result<DeploymentComparison, sqlx::Error> {
    ...
    pub async fn get_comparison(
        ...
        from_deployment_id: Uuid,
        to_deployment_id: Uuid,
    ) -> Result<Option<DeploymentComparison>, sqlx::Error> {
        let row = sqlx::query_as::<_, ComparisonRow>(
    ...
    pub async fn get_deployment_analytics(
        &self,
        environment_id: Uuid,
    ) -> Result<Vec<DeploymentAnalytics>, sqlx::Error> {
    ...
    pub async fn generate_deployment_analytics(
        ...
        environment_id: Uuid,
        period_start: DateTime<Utc>,
    ) -> Result<DeploymentAnalytics, sqlx::Error> {
...
mod tests {
    ...
    fn test_deployment_serialize() {
        let deployment = EnvironmentDeploymentHistory {
            id: Uuid::new_v4(),
