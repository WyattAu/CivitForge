...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CreateTestSuiteMetricV15Request {
    pub metric_name: String,
    pub metric_value: f64,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CreateTestSuiteBaselineV15Request {
    pub metric_name: String,
    pub baseline_value: f64,
    pub threshold_percent: Option<f64>,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct UpdateTestSuiteBaselineV15Request {
    pub baseline_value: Option<f64>,
    pub threshold_percent: Option<f64>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TestSuiteRegressionV15 {
    pub id: Uuid,
    pub baseline_id: Uuid,
    pub metric_name: String,
    pub baseline_value: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TestSuitePerformanceAlertV15 {
    pub id: Uuid,
    pub suite_id: Uuid,
    pub metric_name: String,
    pub baseline_value: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TestSuiteMetricsSummaryV15 {
    pub suite_id: Uuid,
    pub total_metrics: i64,
    pub total_baselines: i64,
    pub active_regressions: i64,
    pub resolved_regressions: i64,
    pub metrics: Vec<TestSuiteMetricV15>,
    pub baselines: Vec<TestSuiteBaselineV15>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct TestSuitePerformanceReportV15 {
    pub suite_id: Uuid,
    pub suite_name: String,
    pub metrics_summary: TestSuiteMetricsSummaryV15,
    pub regressions: Vec<TestSuiteRegressionV15>,
    pub alerts: Vec<TestSuitePerformanceAlertV15>,
    pub overall_score: f64,
    pub last_measured_at: Option<DateTime<Utc>>,
}
