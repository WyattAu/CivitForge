...
pub struct ResidencyReportEntryV5 {
    pub id: Uuid,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ResidencyComplianceEntryV5 {
    pub id: Uuid,
    pub rule_id: Uuid,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ViolationResolutionV5 {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ResidencyAuditLogEntryV5 {
    pub id: Uuid,
    pub action: String,
...
pub struct DataResidencyV8Service {
    pool: PgPool,
}

impl DataResidencyV8Service {
    ...
    pub async fn generate_report(
        &self,
        report_type: &str,
    ) -> Result<ResidencyReportEntryV5, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct ReportRow {
            id: Uuid,
            report_type: String,
    ...
    ) -> Result<Vec<ResidencyReportEntryV5>, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct ReportRow {
            id: Uuid,
            report_type: String,
    ...
    pub async fn track_compliance(
        &self,
        rule_id: Uuid,
    ) -> Result<ResidencyComplianceEntryV5, sqlx::Error> {
        #[derive(sqlx::FromRow)]
    ...
    pub async fn get_compliance_by_rule(
        &self,
        rule_id: Uuid,
    ) -> Result<Vec<ResidencyComplianceEntryV5>, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct ComplianceRow {
            id: Uuid,
            rule_id: Uuid,
        ...
        Ok(rows
            .into_iter()
            .map(|r| ResidencyComplianceEntryV5 {
                id: r.id,
                rule_id: r.rule_id,
    ...
    ) -> Result<ViolationResolutionV5, sqlx::Error> {
        let _ = sqlx::query(
    ...
    pub async fn log_audit(
        ...
        user_id: Option<Uuid>,
        details: serde_json::Value,
    ) -> Result<ResidencyAuditLogEntryV5, sqlx::Error> {
        #[derive(sqlx::FromRow)]
        struct AuditRow {
            id: Uuid,
            action: String,
