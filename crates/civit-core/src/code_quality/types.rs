...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RecordMetricV16Request {
    pub file_path: String,
    pub metric_name: String,
    pub metric_value: f64,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CreateCodeQualityThresholdV15Request {
    pub metric_name: String,
    pub threshold_value: f64,
    pub enabled: Option<bool>,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct UpdateCodeQualityThresholdV15Request {
    pub threshold_value: Option<f64>,
    pub enabled: Option<bool>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CodeQualityViolationV16 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub file_path: String,
    pub metric_name: String,
...
pub struct CodeQualityEnforcementReportV5 {
    ...
    pub violations_by_severity: serde_json::Value,
    pub violations_by_metric: serde_json::Value,
    pub violations: Vec<CodeQualityViolationV16>,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CodeQualityMetricV18 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub file_path: String,
    pub metric_name: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct RecordMetricV18Request {
    pub file_path: String,
    pub metric_name: String,
    pub metric_value: f64,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CodeQualityThresholdV18 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub metric_name: String,
    pub threshold_value: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CreateCodeQualityThresholdV18Request {
    pub metric_name: String,
    pub threshold_value: f64,
    pub enabled: Option<bool>,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct UpdateCodeQualityThresholdV18Request {
    pub threshold_value: Option<f64>,
    pub enabled: Option<bool>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CodeQualityViolationV18 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub file_path: String,
    pub metric_name: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CodeQualityEnforcementReportV6 {
    pub repo_id: Uuid,
    pub total_thresholds: i64,
    pub active_thresholds: i64,
    pub total_violations: i64,
    pub violations_by_severity: serde_json::Value,
    pub violations_by_metric: serde_json::Value,
    pub violations: Vec<CodeQualityViolationV18>,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CodeQualityScoreV6 {
    pub repo_id: Uuid,
    pub overall_score: f64,
    pub metrics_evaluated: i64,
    pub thresholds_passed: i64,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct CodeQualityMetricSummaryV6 {
    pub metric_name: String,
    pub latest_value: f64,
    pub avg_value: f64,
    pub min_value: f64,
