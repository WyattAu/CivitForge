//! Pipeline Action Reviews: Enhanced review system with helpfulness,
...
pub struct PipelineActionReview {
    pub id: Uuid,
    pub action_id: Uuid,
    pub user_id: Uuid,
    pub rating: i32,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ReviewModerationQueue {
    pub id: Uuid,
    pub review_id: Uuid,
    pub status: String,
...
impl From<ReviewRow> for PipelineActionReview {
    fn from(row: ReviewRow) -> Self {
        PipelineActionReview {
            id: row.id,
...
impl From<HelpfulnessRow> for ReviewHelpfulness {
    fn from(row: HelpfulnessRow) -> Self {
        ReviewHelpfulness {
            id: row.id,
...
impl From<ModerationRow> for ReviewModerationQueue {
...
impl From<AnalyticsRow> for ReviewAnalytics {
...
impl From<RecommendationRow> for ReviewRecommendation {
...
pub struct PipelineActionReviewsService {
    pool: PgPool,
}

impl PipelineActionReviewsService {
    ...
    ) -> Result<PipelineActionReview, sqlx::Error> {
    ...
    pub async fn get_review(
        ...
        action_id: Uuid,
        user_id: Uuid,
    ) -> Result<Option<PipelineActionReview>, sqlx::Error> {
        let row = sqlx::query_as::<_, ReviewRow>(
    ...
    pub async fn list_reviews_for_action(
        ...
        limit: i64,
        offset: i64,
    ) -> Result<Vec<PipelineActionReview>, sqlx::Error> {
    ...
    pub async fn toggle_helpfulness(
        ...
        user_id: Uuid,
        helpful: bool,
    ) -> Result<ReviewHelpfulness, sqlx::Error> {
        let row = sqlx::query_as::<_, HelpfulnessRow>(
    ...
    ) -> Result<ReviewModerationQueue, sqlx::Error> {
    ...
    pub async fn get_pending_moderations(
        ...
        limit: i64,
        offset: i64,
    ) -> Result<Vec<ReviewModerationQueue>, sqlx::Error> {
    ...
    pub async fn get_review_analytics(
        &self,
        action_id: Uuid,
    ) -> Result<Vec<ReviewAnalytics>, sqlx::Error> {
    ...
    pub async fn create_recommendation(
        ...
        reason: &str,
        confidence: f64,
    ) -> Result<ReviewRecommendation, sqlx::Error> {
    ...
    pub async fn get_recommendations_for_action(
        &self,
        action_id: Uuid,
    ) -> Result<Vec<ReviewRecommendation>, sqlx::Error> {
...
mod tests {
    ...
    fn test_review_serialize() {
        let review = PipelineActionReview {
            id: Uuid::new_v4(),
    ...
    #[test]
    fn test_helpfulness_serialize() {
        let h = ReviewHelpfulness {
            id: Uuid::new_v4(),
