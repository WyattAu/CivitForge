...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct CodeQualityMetricV13 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub file_path: String,
    pub metric_name: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct PerformanceTestAlertV14 {
    pub id: Uuid,
    pub baseline_id: Uuid,
    pub alert_type: String,
    pub threshold: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct PerformanceTestAlertHistoryV14 {
    pub id: Uuid,
    pub alert_id: Uuid,
    pub metric_name: String,
    pub metric_value: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct DatabaseReplicationConfigV11 {
    pub id: Uuid,
    pub replica_id: Uuid,
    pub config_key: String,
    pub config_value: serde_json::Value,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct DatabaseReplicationAlertV11 {
    pub id: Uuid,
    pub replica_id: Uuid,
    pub alert_type: String,
    pub threshold: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct EncryptionKeyVersionV11 {
    pub id: Uuid,
    pub key_id: Uuid,
    pub version: i32,
    pub key_material: Vec<u8>,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct EncryptionComplianceCheckV11 {
    pub id: Uuid,
    pub check_type: String,
    pub status: String,
    pub findings: serde_json::Value,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct DataResidencyReportV11 {
    pub id: Uuid,
    pub report_type: String,
    pub findings: serde_json::Value,
    pub score: i32,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct DataResidencyComplianceV11 {
    pub id: Uuid,
    pub rule_id: Uuid,
    pub compliance_status: String,
    pub last_checked_at: DateTime<Utc>,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct WorkflowTemplateV12 {
    pub id: Uuid,
    pub name: String,
    pub description: String,
    pub template_type: String,
...
// --- Workflow Template Reviews v11 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct WorkflowTemplateReviewV11 {
    pub id: Uuid,
    pub template_id: Uuid,
    pub user_id: Uuid,
    pub rating: i32,
...
// --- Automation Rules v15 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct AutomationRuleV15 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub name: String,
    pub trigger_type: String,
...
// --- Scheduled Task Templates v12 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct ScheduledTaskTemplateV12 {
    pub id: Uuid,
    pub name: String,
    pub description: String,
    pub task_type: String,
...
// --- Workflow Templates v13 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct WorkflowTemplateV13 {
    pub id: Uuid,
    pub name: String,
    pub description: String,
    pub template_type: String,
...
// --- Workflow Template Reviews v12 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct WorkflowTemplateReviewV12 {
    pub id: Uuid,
    pub template_id: Uuid,
    pub user_id: Uuid,
    pub rating: i32,
...
// --- Automation Rules v16 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct AutomationRuleV16 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub name: String,
    pub trigger_type: String,
...
// --- Scheduled Task Templates v13 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct ScheduledTaskTemplateV13 {
    pub id: Uuid,
    pub name: String,
    pub description: String,
    pub task_type: String,
...
// --- Test Suite Management v14 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct TestSuiteMetricV14 {
    pub id: Uuid,
    pub suite_id: Uuid,
    pub metric_name: String,
    pub metric_value: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct TestSuiteBaselineV14 {
    pub id: Uuid,
    pub suite_id: Uuid,
    pub metric_name: String,
    pub baseline_value: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct CodeQualityThresholdV14 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub metric_name: String,
    pub threshold_value: f64,
...
// --- Performance Testing v15 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct PerformanceTestAlertV15 {
    pub id: Uuid,
    pub baseline_id: Uuid,
    pub alert_type: String,
    pub threshold: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct PerformanceTestAlertHistoryV15 {
    pub id: Uuid,
    pub alert_id: Uuid,
    pub metric_name: String,
    pub metric_value: f64,
...
// --- Test Suite Management v15 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct TestSuiteMetricV15 {
    pub id: Uuid,
    pub suite_id: Uuid,
    pub metric_name: String,
    pub metric_value: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct TestSuiteBaselineV15 {
    pub id: Uuid,
    pub suite_id: Uuid,
    pub metric_name: String,
    pub baseline_value: f64,
...
// --- Code Quality Rules v15 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct CodeQualityMetricV15 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub file_path: String,
    pub metric_name: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct CodeQualityThresholdV15 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub metric_name: String,
    pub threshold_value: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct PerformanceTestAlertV16 {
    pub id: Uuid,
    pub baseline_id: Uuid,
    pub alert_type: String,
    pub threshold: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct PerformanceTestAlertHistoryV16 {
    pub id: Uuid,
    pub alert_id: Uuid,
    pub metric_name: String,
    pub metric_value: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct TestSuiteBaselineV16 {
    pub id: Uuid,
    pub suite_id: Uuid,
    pub metric_name: String,
    pub baseline_value: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct CodeQualityMetricV16 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub file_path: String,
    pub metric_name: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct CodeQualityThresholdV16 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub metric_name: String,
    pub threshold_value: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct PerformanceTestAlertV17 {
    pub id: Uuid,
    pub baseline_id: Uuid,
    pub alert_type: String,
    pub threshold: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct PerformanceTestAlertHistoryV17 {
    pub id: Uuid,
    pub alert_id: Uuid,
    pub metric_name: String,
    pub metric_value: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct TestSuiteBaselineV17 {
    pub id: Uuid,
    pub suite_id: Uuid,
    pub metric_name: String,
    pub baseline_value: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct CodeQualityMetricV17 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub file_path: String,
    pub metric_name: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct CodeQualityThresholdV17 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub metric_name: String,
    pub threshold_value: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct PerformanceTestAlertV18 {
    pub id: Uuid,
    pub baseline_id: Uuid,
    pub alert_type: String,
    pub threshold: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct PerformanceTestAlertHistoryV18 {
    pub id: Uuid,
    pub alert_id: Uuid,
    pub metric_name: String,
    pub metric_value: f64,
...
// --- Workflow Templates v14 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct WorkflowTemplateV14 {
    pub id: Uuid,
    pub name: String,
    pub description: String,
    pub template_type: String,
...
// --- Workflow Template Reviews v13 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct WorkflowTemplateReviewV13 {
    pub id: Uuid,
    pub template_id: Uuid,
    pub user_id: Uuid,
    pub rating: i32,
...
// --- Automation Rules v17 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct AutomationRuleV17 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub name: String,
    pub trigger_type: String,
...
// --- Scheduled Task Templates v14 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct ScheduledTaskTemplateV14 {
    pub id: Uuid,
    pub name: String,
    pub description: String,
    pub task_type: String,
...
// --- Workflow Templates v15 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct WorkflowTemplateV15 {
    pub id: Uuid,
    pub name: String,
    pub description: String,
    pub template_type: String,
...
// --- Workflow Template Reviews v14 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct WorkflowTemplateReviewV14 {
    pub id: Uuid,
    pub template_id: Uuid,
    pub user_id: Uuid,
    pub rating: i32,
...
// --- Automation Rules v18 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct AutomationRuleV18 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub name: String,
    pub trigger_type: String,
...
// --- Scheduled Task Templates v15 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct ScheduledTaskTemplateV15 {
    pub id: Uuid,
    pub name: String,
    pub description: String,
    pub task_type: String,
...
// --- Workflow Templates v16 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct WorkflowTemplateV16 {
    pub id: Uuid,
    pub name: String,
    pub description: String,
    pub template_type: String,
...
// --- Workflow Template Reviews v15 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct WorkflowTemplateReviewV15 {
    pub id: Uuid,
    pub template_id: Uuid,
    pub user_id: Uuid,
    pub rating: i32,
...
// --- Automation Rules v19 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct AutomationRuleV19 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub name: String,
    pub trigger_type: String,
...
// --- Scheduled Task Templates v16 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct ScheduledTaskTemplateV16 {
    pub id: Uuid,
    pub name: String,
    pub description: String,
    pub task_type: String,
...
// --- Workflow Templates v17 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct WorkflowTemplateV17 {
    pub id: Uuid,
    pub name: String,
    pub description: String,
    pub template_type: String,
...
// --- Workflow Template Reviews v16 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct WorkflowTemplateReviewV16 {
    pub id: Uuid,
    pub template_id: Uuid,
    pub user_id: Uuid,
    pub rating: i32,
...
// --- Automation Rules v20 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct AutomationRuleV20 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub name: String,
    pub trigger_type: String,
...
// --- Scheduled Task Templates v17 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct ScheduledTaskTemplateV17 {
    pub id: Uuid,
    pub name: String,
    pub description: String,
    pub task_type: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct TestSuiteBaselineV19 {
    pub id: Uuid,
    pub suite_id: Uuid,
    pub metric_name: String,
    pub baseline_value: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct CodeQualityMetricV19 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub file_path: String,
    pub metric_name: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct CodeQualityThresholdV19 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub metric_name: String,
    pub threshold_value: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct PerformanceTestAlertV20 {
    pub id: Uuid,
    pub baseline_id: Uuid,
    pub alert_type: String,
    pub threshold: f64,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct PerformanceTestAlertHistoryV20 {
    pub id: Uuid,
    pub alert_id: Uuid,
    pub metric_name: String,
    pub metric_value: f64,
...
// --- Workflow Templates v18 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct WorkflowTemplateV18 {
    pub id: Uuid,
    pub name: String,
    pub description: String,
    pub template_type: String,
...
// --- Workflow Template Reviews v17 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct WorkflowTemplateReviewV17 {
    pub id: Uuid,
    pub template_id: Uuid,
    pub user_id: Uuid,
    pub rating: i32,
...
// --- Automation Rules v21 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct AutomationRuleV21 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub name: String,
    pub trigger_type: String,
...
// --- Scheduled Task Templates v18 ---

// --- API Docs v22 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct ApiDocsV22 {
    pub id: Uuid,
    pub endpoint: String,
    pub method: String,
    pub version: String,
...
// --- Rate Limit Alerts v17 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct RateLimitAlertV17 {
    pub id: Uuid,
    pub user_id: Uuid,
    pub tier_id: Uuid,
    pub alert_type: String,
...
#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct ScheduledTaskTemplateV18 {
    pub id: Uuid,
    pub name: String,
    pub description: String,
    pub task_type: String,
...
// --- Workflow Templates v19 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct WorkflowTemplateV19 {
    pub id: Uuid,
    pub name: String,
    pub description: String,
    pub template_type: String,
...
// --- Workflow Template Reviews v18 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct WorkflowTemplateReviewV18 {
    pub id: Uuid,
    pub template_id: Uuid,
    pub user_id: Uuid,
    pub rating: i32,
...
// --- Automation Rules v22 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct AutomationRuleV22 {
    pub id: Uuid,
    pub repo_id: Uuid,
    pub name: String,
    pub trigger_type: String,
...
// --- Scheduled Task Templates v19 ---

#[derive(Debug, Clone, Serialize, Deserialize, sqlx::FromRow)]
pub struct ScheduledTaskTemplateV19 {
    pub id: Uuid,
    pub name: String,
    pub description: String,
    pub task_type: String,
