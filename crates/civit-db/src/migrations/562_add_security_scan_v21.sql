CREATE TABLE IF NOT EXISTS security_scan_rules_v20 (
...
CREATE TABLE IF NOT EXISTS security_scan_fixes_v18 (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    scan_id UUID NOT NULL REFERENCES security_scans_v2(id),
    rule_id UUID NOT NULL REFERENCES security_scan_rules_v20(id),
