...
pub const M_490_TEST_SUITE_MANAGEMENT_V16_DOWN: &str =
...
impl MigrationManager {
    ...
    fn register_builtins(&mut self) {
        ...
        self.add_migration(Migration {
            version: 490,
            name: "add_test_suite_management_v16".into(),
            up_sql: M_490_TEST_SUITE_MANAGEMENT_V16_UP.into(),
            down_sql: M_490_TEST_SUITE_MANAGEMENT_V16_DOWN.into(),
        });
        self.add_migration(Migration {
            version: 491,
            name: "add_code_quality_rules_v16".into(),
            up_sql: M_491_CODE_QUALITY_RULES_V16_UP.into(),
            down_sql: M_491_CODE_QUALITY_RULES_V16_DOWN.into(),
        });
        self.add_migration(Migration {
            version: 492,
            name: "add_performance_testing_v17".into(),
        ...
        self.add_migration(Migration {
            version: 517,
            name: "add_database_replication_v17".into(),
            up_sql: M_517_DATABASE_REPLICATION_V17_UP.into(),
            down_sql: M_517_DATABASE_REPLICATION_V17_DOWN.into(),
        });
        self.add_migration(Migration {
            version: 518,
            name: "add_encryption_v18".into(),
            up_sql: M_518_ENCRYPTION_V18_UP.into(),
            down_sql: M_518_ENCRYPTION_V18_DOWN.into(),
        });
        self.add_migration(Migration {
            version: 519,
            name: "add_data_residency_v17".into(),
            up_sql: M_519_DATA_RESIDENCY_V17_UP.into(),
            down_sql: M_519_DATA_RESIDENCY_V17_DOWN.into(),
        });
        self.add_migration(Migration {
            version: 520,
            name: "add_security_scan_rules_v19".into(),
            up_sql: M_520_SECURITY_SCAN_V19_UP.into(),
            down_sql: M_520_SECURITY_SCAN_V19_DOWN.into(),
        });
        self.add_migration(Migration {
            version: 521,
            name: "add_compliance_frameworks_v19".into(),
            up_sql: M_521_COMPLIANCE_V19_UP.into(),
            down_sql: M_521_COMPLIANCE_V19_DOWN.into(),
        });
        self.add_migration(Migration {
            version: 522,
            name: "add_audit_trail_v19".into(),
        ...
        self.add_migration(Migration {
            version: 541,
            name: "add_security_scan_v20".into(),
            up_sql: M_541_SECURITY_SCAN_V20_UP.into(),
            down_sql: M_541_SECURITY_SCAN_V20_DOWN.into(),
        });
        self.add_migration(Migration {
            version: 542,
            name: "add_compliance_v20".into(),
            up_sql: M_542_COMPLIANCE_V20_UP.into(),
            down_sql: M_542_COMPLIANCE_V20_DOWN.into(),
        });
        self.add_migration(Migration {
            version: 543,
        ...
        self.add_migration(Migration {
            version: 574,
            name: "add_test_suite_management_v20".into(),
            up_sql: M_574_TEST_SUITE_MANAGEMENT_V20_UP.into(),
            down_sql: M_574_TEST_SUITE_MANAGEMENT_V20_DOWN.into(),
        });
        self.add_migration(Migration {
            version: 575,
            name: "add_code_quality_rules_v20".into(),
            up_sql: M_575_CODE_QUALITY_RULES_V20_UP.into(),
            down_sql: M_575_CODE_QUALITY_RULES_V20_DOWN.into(),
        });
        self.add_migration(Migration {
            version: 576,
