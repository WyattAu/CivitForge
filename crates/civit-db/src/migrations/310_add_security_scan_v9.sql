CREATE TABLE IF NOT EXISTS security_scan_rules_v8 (
...
CREATE TABLE IF NOT EXISTS security_scan_fixes_v6 (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    scan_id UUID NOT NULL REFERENCES security_scans_v2(id),
    rule_id UUID NOT NULL REFERENCES security_scan_rules_v8(id),
