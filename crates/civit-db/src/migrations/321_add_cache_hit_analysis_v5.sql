CREATE TABLE IF NOT EXISTS cache_hit_analysis_v5 (
...
CREATE TABLE IF NOT EXISTS cache_size_tracking_v5 (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    cache_id UUID NOT NULL REFERENCES pipeline_caches_v2(id),
...
CREATE TABLE IF NOT EXISTS cache_cost_optimization_v5 (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    cache_id UUID NOT NULL REFERENCES pipeline_caches_v2(id),
    period_start TIMESTAMPTZ NOT NULL,
...
CREATE TABLE IF NOT EXISTS cache_performance_insights_v5 (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    cache_id UUID NOT NULL REFERENCES pipeline_caches_v2(id),
    period_start TIMESTAMPTZ NOT NULL,
